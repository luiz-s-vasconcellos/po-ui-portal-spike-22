import {f as fe,u as ue$1,s as sr,D as DL,w,c3 as Xn,a as wn,U as Un,c as f,aW as Yp,cY as kz,L as Gl,an as AO,aH as Ka,b8 as Ume,b9 as $me,T as Tl,C as iN,M as sg,a1 as ht,H as Vp,ar as qx,au as fg,O as nw,bs as mN,aX as oY,aF as nY,aY as rY,aG as Sk,aZ as Ck,b0 as Qt,b1 as mv,c4 as b3,b4 as L3,cp as Bhe,c8 as Tde,c9 as jhe,aB as Sx,aM as ww,aN as r0,aO as Ew,aP as o0,cZ as Hhe,b6 as Yo,av as Yl,aw as uo,ax as fo,a3 as sNe,aD as Ky,aT as sN,aE as Xy}from'./main-JFQ6NFFH.js';var re=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-login-basic"]],standalone:false,decls:1,vars:0,consts:[["name","login","p-label","PO Login"]],template:function(l,i){l&1&&Gl(0,"po-login",0);},dependencies:[kz],encapsulation:2,changeDetection:1})}return a})();var be=a=>({"docs-sample-code-tabs":a}),de=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-login-basic-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),iN(3,"PO Login Basic"),sg(),Tl(4,"a",2),ht("click",function(){return i.toggleSampleCodeTabs()}),Gl(5,"span"),iN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),iN(12,"sample-po-login-basic/sample-po-login-basic.component.html"),sg(),Tl(13,"pre",7),iN(14,`<po-login name="login" p-label="PO Login"> </po-login>
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),iN(18,"sample-po-login-basic/sample-po-login-basic.component.ts"),sg(),Tl(19,"pre",9),iN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),iN(18,"sample-po-login-labs/sample-po-login-labs.component.ts"),sg(),Tl(19,"pre",9),iN(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()()()(),Tl(21,"div",10),Gl(22,"sample-po-login-labs"),sg(),Gl(23,"hr")),l&2&&(Vp(5),qx("po-icon "+i.sampleCodeButtonIcon),Vp(),fg(" ",i.sampleCodeButtonLabel),Vp(),nw("ngClass",mN(4,Ce,i.hideSampleCodeTabs)));},dependencies:[AO,Ka,Ume,$me,pe],encapsulation:2,changeDetection:1})}return a})();var ce=(()=>{class a{poNotification=f(Yp);poModal;userLogin;userPassword;primaryAction={label:"Confirm",action:()=>{this.confirmAction();}};openModal(){this.poModal.open();}cleanForm(){this.userLogin="",this.userPassword="";}confirmAction(){this.userLogin&&this.userPassword&&(this.poNotification.success(`Discount successfully applied to user ${this.userLogin}!`),this.poModal.close(),this.cleanForm());}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-login-confirm"]],viewQuery:function(l,i){if(l&1&&Yl(Yo,7),l&2){let s;uo(s=fo())&&(i.poModal=s.first);}},standalone:false,decls:7,vars:3,consts:[[1,"po-text-center"],[1,"po-font-subtitle"],["p-label","Confirm Identity",3,"p-click"],["p-hide-close","true","p-size","auto","p-title","Confirm your identity",3,"p-primary-action"],["name","userLogin","p-clean","","p-label","User","p-maxlength","40","p-placeholder","domain\\user","p-required","",3,"ngModelChange","ngModel"],["name","userPassword","p-clean","","p-label","Password","p-placeholder","Enter your password","p-required","",3,"ngModelChange","ngModel"]],template:function(l,i){l&1&&(Tl(0,"div",0)(1,"div",1),iN(2," To gain a 25% discount on your purchases, confirm your identity with your username and password! "),sg(),Tl(3,"po-button",2),ht("p-click",function(){return i.openModal()}),sg()(),Tl(4,"po-modal",3)(5,"po-login",4),ww("ngModelChange",function(p){return sN(i.userLogin,p)||(i.userLogin=p),p}),sg(),r0(),Tl(6,"po-password",5),ww("ngModelChange",function(p){return sN(i.userPassword,p)||(i.userPassword=p),p}),sg(),r0(),sg()),l&2&&(Vp(4),nw("p-primary-action",i.primaryAction),Vp(),Ew("ngModel",i.userLogin),o0(),Vp(),Ew("ngModel",i.userPassword),o0());},dependencies:[nY,Sk,Qt,kz,Hhe,Yo],encapsulation:2,changeDetection:1})}return a})();var we=a=>({"docs-sample-code-tabs":a}),ue=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-login-confirm-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),iN(3,"PO Login - Confirm Identity"),sg(),Tl(4,"a",2),ht("click",function(){return i.toggleSampleCodeTabs()}),Gl(5,"span"),iN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),iN(12,"sample-po-login-confirm/sample-po-login-confirm.component.html"),sg(),Tl(13,"pre",7),iN(14,`<div class="po-text-center">
...
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),iN(18,"sample-po-login-confirm/sample-po-login-confirm.component.ts"),sg(),Tl(19,"pre",9),iN(20,`import { Component, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
