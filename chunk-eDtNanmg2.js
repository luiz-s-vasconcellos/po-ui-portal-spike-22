import{$r as Vx,Et as V8e,F as G4,Hr as Tw,Ii as ht,Ir as Qy,It as Zt,Jn as CY,Ki as lo,Kr as Un,M as ECe,Mi as gg,Mn as xbe,Ni as he,P as Eu,Qi as oN,Sa as yN,Sn as sU,Ti as f0,Ui as lg,Vi as kk,Xn as Cn,Yi as mN,Zr as Vk,_r as Ml,ar as IY,bi as cw,br as NL,ci as Yx,cn as lU,cr as K,da as uo,dn as oU,ea as p0,ga as w,l as ar,mn as q0e,mr as MN,nr as HO,oa as ql,on as kbe,qr as Up,r as Ga,ri as Xn,sr as Jy,ua as ue$1,ui as Zl,un as nb,va as wY,vr as Mw,vt as SCe,wi as f}from"./main-NT5YGKBQ.js";var de=(()=>{class a{static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-url-basic`]],standalone:!1,decls:1,vars:0,consts:[[`name`,`url`,`p-label`,`PO Url`]],template:function(l,i){l&1&&ql(0,`po-url`,0)},dependencies:[sU],encapsulation:2,changeDetection:1})}return a})();var ge=a=>({"docs-sample-code-tabs":a});var pe=(()=>{class a{hideSampleCodeTabs=!0;sampleCodeButtonLabel=`Talk is cheap, show me the code!`;sampleCodeButtonIcon=`an an-plus`;toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?`Talk is cheap, show me the code!`:`Okay, hide the code`,this.sampleCodeButtonIcon=this.hideSampleCodeTabs?`an an-plus`:`an an-minus`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-url-basic-view`]],standalone:!1,decls:24,vars:6,consts:[[1,`sample-blockquote`],[1,`sample-title`,`po-font-text-large-bold`],[1,`show-me-the-code`,3,`click`],[3,`ngClass`],[`p-size`,`2`],[`p-label`,`HTML`,`p-active`,``],[1,`doc-label-path`],[`appCodeHighlight`,``,1,`html`],[`p-label`,`TS`],[`appCodeHighlight`,``,1,`typescript`],[1,`docs-sample-container`]],template:function(l,i){l&1&&(ql(0,`br`),Ml(1,`blockquote`,0)(2,`label`,1),mN(3,`PO Url Basic`),lg(),Ml(4,`a`,2),ht(`click`,function(){return i.toggleSampleCodeTabs()}),ql(5,`span`),mN(6),lg()(),Ml(7,`div`,3)(8,`po-tabs`,4)(9,`po-tab`,5)(10,`div`)(11,`label`,6),mN(12,`sample-po-url-basic/sample-po-url-basic.component.html`),lg(),Ml(13,`pre`,7),mN(14,`<po-url name="url" p-label="PO Url"> </po-url>
`),lg()()(),Ml(15,`po-tab`,8)(16,`div`)(17,`label`,6),mN(18,`sample-po-url-basic/sample-po-url-basic.component.ts`),lg(),Ml(19,`pre`,9),mN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),lg()()(),Ml(15,`po-tab`,8)(16,`div`)(17,`label`,6),mN(18,`sample-po-url-labs/sample-po-url-labs.component.ts`),lg(),Ml(19,`pre`,9),mN(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),lg()()()()(),Ml(21,`div`,10),ql(22,`sample-po-url-labs`),lg(),ql(23,`hr`)),l&2&&(Up(5),oN(`po-icon `+i.sampleCodeButtonIcon),Up(),gg(` `,i.sampleCodeButtonLabel),Up(),cw(`ngClass`,MN(4,ye,i.hideSampleCodeTabs)))},dependencies:[HO,Ga,SCe,ECe,se],encapsulation:2,changeDetection:1})}return a})();var Pe=[`boxUrl`];var ue=(()=>{class a{poNotification=f(Eu);boxUrlElement;baseUrls=[];shortenedUrl;url;urlColumns=[{property:`url`,label:`Long URL`},{property:`short`,label:`Shortened URL`}];copyToClipboard(){this.boxUrlElement.nativeElement.querySelector(`input`).select(),document.execCommand(`copy`),this.poNotification.success(`Text copied!`)}shortenUrl(){let m=btoa(this.url.replace(/http|www|com|br|\/|\./gi,``).trim());this.shortenedUrl=`po.com/${m.substr(m.length-3)}`+this.baseUrls.length,this.baseUrls.push({url:this.url,short:this.shortenedUrl})}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-url-shortener`]],viewQuery:function(l,i){if(l&1&&Zl(Pe,7,K),l&2){let p;lo(p=uo())&&(i.boxUrlElement=p.first)}},standalone:!1,decls:11,vars:7,consts:[[`f`,`ngForm`],[`boxUrl`,``],[1,`po-row`],[`name`,`url`,`p-label`,`Type your URL to be shortened`,`p-required`,``,1,`po-lg-6`,3,`ngModelChange`,`ngModel`],[`name`,`shortenedUrl`,`p-label`,`URL shortened`,`p-readonly`,``,1,`po-lg-6`,3,`ngModelChange`,`ngModel`],[`p-label`,`Shorten URL`,`p-kind`,`primary`,1,`po-lg-2`,3,`p-click`,`p-disabled`],[`p-icon`,`an an-copy`,`p-label`,`Copy`,1,`po-offset-lg-4`,`po-offset-xl-4`,`po-lg-2`,3,`click`,`p-disabled`],[`p-striped`,`true`,3,`p-columns`,`p-items`,`p-hide-table-search`]],template:function(l,i){if(l&1){let p=Vx();Ml(0,`form`,null,0)(2,`div`,2)(3,`po-url`,3),Mw(`ngModelChange`,function(r){return Qy(p),yN(i.url,r)||(i.url=r),Jy(r)}),lg(),f0(),Ml(4,`po-input`,4,1),Mw(`ngModelChange`,function(r){return Qy(p),yN(i.shortenedUrl,r)||(i.shortenedUrl=r),Jy(r)}),lg(),f0(),lg(),Ml(6,`div`,2)(7,`po-button`,5),ht(`p-click`,function(){return i.shortenUrl()}),lg(),Ml(8,`po-button`,6),ht(`click`,function(){return i.copyToClipboard()}),lg()()(),ql(9,`po-divider`)(10,`po-table`,7)}if(l&2){let p=Yx(1);Up(3),Tw(`ngModel`,i.url),p0(),Up(),Tw(`ngModel`,i.shortenedUrl),p0(),Up(3),cw(`p-disabled`,p.invalid),Up(),cw(`p-disabled`,!i.shortenedUrl),Up(2),cw(`p-columns`,i.urlColumns)(`p-items`,i.baseUrls)(`p-hide-table-search`,!1)}},dependencies:[IY,wY,CY,Vk,kk,Zt,nb,lU,sU,oU],encapsulation:2,changeDetection:1})}return a})();var Me=a=>({"docs-sample-code-tabs":a});var Ee=(()=>{class a{hideSampleCodeTabs=!0;sampleCodeButtonLabel=`Talk is cheap, show me the code!`;sampleCodeButtonIcon=`an an-plus`;toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?`Talk is cheap, show me the code!`:`Okay, hide the code`,this.sampleCodeButtonIcon=this.hideSampleCodeTabs?`an an-plus`:`an an-minus`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-url-shortener-view`]],standalone:!1,decls:24,vars:6,consts:[[1,`sample-blockquote`],[1,`sample-title`,`po-font-text-large-bold`],[1,`show-me-the-code`,3,`click`],[3,`ngClass`],[`p-size`,`2`],[`p-label`,`HTML`,`p-active`,``],[1,`doc-label-path`],[`appCodeHighlight`,``,1,`html`],[`p-label`,`TS`],[`appCodeHighlight`,``,1,`typescript`],[1,`docs-sample-container`]],template:function(l,i){l&1&&(ql(0,`br`),Ml(1,`blockquote`,0)(2,`label`,1),mN(3,`PO Url - Shortener`),lg(),Ml(4,`a`,2),ht(`click`,function(){return i.toggleSampleCodeTabs()}),ql(5,`span`),mN(6),lg()(),Ml(7,`div`,3)(8,`po-tabs`,4)(9,`po-tab`,5)(10,`div`)(11,`label`,6),mN(12,`sample-po-url-shortener/sample-po-url-shortener.component.html`),lg(),Ml(13,`pre`,7),mN(14,`<form #f="ngForm">
  <div class="po-row">
...
`),lg()()(),Ml(15,`po-tab`,8)(16,`div`)(17,`label`,6),mN(18,`sample-po-url-shortener/sample-po-url-shortener.component.ts`),lg(),Ml(19,`pre`,9),mN(20,`import { Component, ElementRef, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
