import{$r as Xy,$t as iU,At as _Ce,Bi as jp,Ei as f,Fi as he,Gr as Un,Hn as Ax,Hr as Tl,Ii as hg,Ji as mY,Ki as lo,Li as ht,Ni as gY,Nr as PO,Ot as Zt,P as GH,Qn as DN,Qr as Xx,Tt as Xy$1,U as L0e,Ui as l0,Vn as Ak,Vr as Tk,X as N4,Xi as nw,Xr as Xn,Yn as Cn,Yt as hbe,_r as Ky,aa as uN,ei as Yl,fi as ag,gi as bL,ha as ww,jn as ybe,k as Eu,l as ar,la as uo,lr as Gl,on as mCe,pa as w,r as Ga,rr as Ew,sa as ue$1,ui as a0,ut as S8e,va as yY,wn as vr,yi as cN,yn as ube}from"./main-3EWTGE7T.js";var re=(()=>{class a{static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-basic`]],standalone:!1,decls:1,vars:0,consts:[[`name`,`login`,`p-label`,`PO Login`]],template:function(l,i){l&1&&Gl(0,`po-login`,0)},dependencies:[GH],encapsulation:2,changeDetection:1})}return a})();var be=a=>({"docs-sample-code-tabs":a});var de=(()=>{class a{hideSampleCodeTabs=!0;sampleCodeButtonLabel=`Talk is cheap, show me the code!`;sampleCodeButtonIcon=`an an-plus`;toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?`Talk is cheap, show me the code!`:`Okay, hide the code`,this.sampleCodeButtonIcon=this.hideSampleCodeTabs?`an an-plus`:`an an-minus`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-basic-view`]],standalone:!1,decls:24,vars:6,consts:[[1,`sample-blockquote`],[1,`sample-title`,`po-font-text-large-bold`],[1,`show-me-the-code`,3,`click`],[3,`ngClass`],[`p-size`,`2`],[`p-label`,`HTML`,`p-active`,``],[1,`doc-label-path`],[`appCodeHighlight`,``,1,`html`],[`p-label`,`TS`],[`appCodeHighlight`,``,1,`typescript`],[1,`docs-sample-container`]],template:function(l,i){l&1&&(Gl(0,`br`),Tl(1,`blockquote`,0)(2,`label`,1),cN(3,`PO Login Basic`),ag(),Tl(4,`a`,2),ht(`click`,function(){return i.toggleSampleCodeTabs()}),Gl(5,`span`),cN(6),ag()(),Tl(7,`div`,3)(8,`po-tabs`,4)(9,`po-tab`,5)(10,`div`)(11,`label`,6),cN(12,`sample-po-login-basic/sample-po-login-basic.component.html`),ag(),Tl(13,`pre`,7),cN(14,`<po-login name="login" p-label="PO Login"> </po-login>
`),ag()()(),Tl(15,`po-tab`,8)(16,`div`)(17,`label`,6),cN(18,`sample-po-login-basic/sample-po-login-basic.component.ts`),ag(),Tl(19,`pre`,9),cN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),ag()()()()(),Tl(21,`div`,10),Gl(22,`sample-po-login-basic`),ag(),Gl(23,`hr`)),l&2&&(jp(5),Xx(`po-icon `+i.sampleCodeButtonIcon),jp(),hg(` `,i.sampleCodeButtonLabel),jp(),nw(`ngClass`,DN(4,be,i.hideSampleCodeTabs)))},dependencies:[PO,Ga,mCe,_Ce,re],encapsulation:2,changeDetection:1})}return a})();var pe=(()=>{class a{helperText;errorPattern;event;help;label;login;maxlength;minlength;pattern;placeholder;properties;size;propertiesOptions=[{value:`clean`,label:`Clean`},{value:`disabled`,label:`Disabled`},{value:`errorLimit`,label:`Limit Error Message`},{value:`labelTextWrap`,label:`Label Text Wrap`},{value:`compactLabel`,label:`Compact Label`},{value:`loading`,label:`Loading`},{value:`noAutocomplete`,label:`No Autocomplete`},{value:`optional`,label:`Optional`},{value:`readonly`,label:`Read Only`},{value:`required`,label:`Required`},{value:`requiredFieldErrorMessage`,label:`Required Field Error Message`},{value:`showRequired`,label:`Show Required`}];sizeOptions=[{label:`small`,value:`small`},{label:`medium`,value:`medium`}];ngOnInit(){this.restore()}changeEvent(d){this.event=d}restore(){this.helperText=``,this.errorPattern=``,this.event=``,this.label=void 0,this.login=``,this.help=void 0,this.maxlength=void 0,this.minlength=void 0,this.pattern=``,this.placeholder=``,this.properties=[],this.size=`medium`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-labs`]],standalone:!1,decls:20,vars:36,consts:[[`f`,`ngForm`],[`name`,`login`,3,`ngModelChange`,`p-blur`,`p-change`,`p-change-model`,`p-enter`,`p-keydown`,`ngModel`,`p-helper`,`p-clean`,`p-disabled`,`p-error-pattern`,`p-help`,`p-label`,`p-loading`,`p-maxlength`,`p-minlength`,`p-no-autocomplete`,`p-optional`,`p-pattern`,`p-placeholder`,`p-readonly`,`p-required`,`p-required-field-error-message`,`p-show-required`,`p-size`,`p-label-text-wrap`,`p-compact-label`,`p-error-limit`],[1,`po-row`],[`p-label`,`Model`,1,`po-md-6`,3,`p-value`],[`p-label`,`Event`,1,`po-md-6`,3,`p-value`],[`name`,`label`,`p-clean`,``,`p-label`,`Label`,1,`po-md-6`,`po-lg-4`,3,`ngModelChange`,`ngModel`],[`name`,`help`,`p-clean`,``,`p-label`,`Help`,1,`po-md-6`,`po-lg-4`,3,`ngModelChange`,`ngModel`],[`name`,`placeholder`,`p-clean`,``,`p-label`,`Placeholder`,1,`po-md-6`,`po-lg-4`,3,`ngModelChange`,`ngModel`],[`name`,`helperText`,`p-clean`,``,`p-label`,`Additional Help`,1,`po-md-6`,3,`ngModelChange`,`ngModel`],[`name`,`pattern`,`p-clean`,``,`p-help`,`Ex.: '[a-zA]{5}[Z0-9]{3}'`,`p-label`,`Pattern (Regex)`,1,`po-md-6`,3,`ngModelChange`,`ngModel`],[`name`,`errorPattern`,`p-clean`,``,`p-help`,`Ex.: Required field`,`p-label`,`Error pattern`,1,`po-md-6`,3,`ngModelChange`,`ngModel`],[`name`,`minlength`,`p-clean`,``,`p-label`,`Min length`,1,`po-md-6`,`po-lg-3`,3,`ngModelChange`,`ngModel`],[`name`,`maxlength`,`p-clean`,``,`p-label`,`Max length`,1,`po-md-6`,`po-lg-3`,3,`ngModelChange`,`ngModel`],[`name`,`properties`,`p-columns`,`4`,`p-label`,`Properties`,1,`po-md-12`,3,`ngModelChange`,`ngModel`,`p-options`],[`name`,`size`,`p-columns`,`4`,`p-label`,`Size`,`p-help`,`Para aplicar o tamanho small, configure o nível de acessibilidade para AA, ajustável no navbar ou serviço de tema (https://po-ui.io/documentation/po-theme).`,1,`po-md-12`,3,`ngModelChange`,`ngModel`,`p-options`],[`p-label`,`Sample Restore`,1,`po-lg-3`,`po-md-6`,3,`p-click`]],template:function(l,i){if(l&1){let s=Ax();Tl(0,`po-login`,1),ww(`ngModelChange`,function(r){return Ky(s),uN(i.login,r)||(i.login=r),Xy(r)}),ht(`p-blur`,function(){return i.changeEvent(`p-blur`)})(`p-change`,function(){return i.changeEvent(`p-change`)})(`p-change-model`,function(){return i.changeEvent(`p-change-model`)})(`p-enter`,function(){return i.changeEvent(`p-enter`)})(`p-keydown`,function(){return i.changeEvent(`p-keydown`)}),ag(),a0(),Gl(1,`po-divider`),Tl(2,`div`,2),Gl(3,`po-info`,3)(4,`po-info`,4),ag(),Gl(5,`po-divider`),Tl(6,`form`,null,0)(8,`po-input`,5),ww(`ngModelChange`,function(r){return Ky(s),uN(i.label,r)||(i.label=r),Xy(r)}),ag(),a0(),Tl(9,`po-input`,6),ww(`ngModelChange`,function(r){return Ky(s),uN(i.help,r)||(i.help=r),Xy(r)}),ag(),a0(),Tl(10,`po-input`,7),ww(`ngModelChange`,function(r){return Ky(s),uN(i.placeholder,r)||(i.placeholder=r),Xy(r)}),ag(),a0(),Tl(11,`po-input`,8),ww(`ngModelChange`,function(r){return Ky(s),uN(i.helperText,r)||(i.helperText=r),Xy(r)}),ag(),a0(),Tl(12,`po-input`,9),ww(`ngModelChange`,function(r){return Ky(s),uN(i.pattern,r)||(i.pattern=r),Xy(r)}),ag(),a0(),Tl(13,`po-input`,10),ww(`ngModelChange`,function(r){return Ky(s),uN(i.errorPattern,r)||(i.errorPattern=r),Xy(r)}),ag(),a0(),Tl(14,`po-number`,11),ww(`ngModelChange`,function(r){return Ky(s),uN(i.minlength,r)||(i.minlength=r),Xy(r)}),ag(),a0(),Tl(15,`po-number`,12),ww(`ngModelChange`,function(r){return Ky(s),uN(i.maxlength,r)||(i.maxlength=r),Xy(r)}),ag(),a0(),Tl(16,`po-checkbox-group`,13),ww(`ngModelChange`,function(r){return Ky(s),uN(i.properties,r)||(i.properties=r),Xy(r)}),ag(),a0(),Tl(17,`po-radio-group`,14),ww(`ngModelChange`,function(r){return Ky(s),uN(i.size,r)||(i.size=r),Xy(r)}),ag(),a0(),Tl(18,`div`,2)(19,`po-button`,15),ht(`p-click`,function(){return i.restore()}),ag()()()}l&2&&(Ew(`ngModel`,i.login),nw(`p-helper`,i.helperText)(`p-clean`,i.properties.includes(`clean`))(`p-disabled`,i.properties.includes(`disabled`))(`p-error-pattern`,i.errorPattern)(`p-help`,i.help)(`p-label`,i.label)(`p-loading`,i.properties?.includes(`loading`))(`p-maxlength`,i.maxlength)(`p-minlength`,i.minlength)(`p-no-autocomplete`,i.properties?.includes(`noAutocomplete`))(`p-optional`,i.properties.includes(`optional`))(`p-pattern`,i.pattern)(`p-placeholder`,i.placeholder)(`p-readonly`,i.properties.includes(`readonly`))(`p-required`,i.properties.includes(`required`))(`p-required-field-error-message`,i.properties.includes(`requiredFieldErrorMessage`))(`p-show-required`,i.properties.includes(`showRequired`))(`p-size`,i.size)(`p-label-text-wrap`,i.properties?.includes(`labelTextWrap`))(`p-compact-label`,i.properties?.includes(`compactLabel`))(`p-error-limit`,i.properties?.includes(`errorLimit`)),l0(),jp(3),nw(`p-value`,i.login),jp(),nw(`p-value`,i.event),jp(4),Ew(`ngModel`,i.label),l0(),jp(),Ew(`ngModel`,i.help),l0(),jp(),Ew(`ngModel`,i.placeholder),l0(),jp(),Ew(`ngModel`,i.helperText),l0(),jp(),Ew(`ngModel`,i.pattern),l0(),jp(),Ew(`ngModel`,i.errorPattern),l0(),jp(),Ew(`ngModel`,i.minlength),l0(),jp(),Ew(`ngModel`,i.maxlength),l0(),jp(),Ew(`ngModel`,i.properties),nw(`p-options`,i.propertiesOptions),l0(),jp(),Ew(`ngModel`,i.size),nw(`p-options`,i.sizeOptions),l0())},dependencies:[yY,gY,mY,Ak,Tk,Zt,Xy$1,N4,iU,GH,ube,L0e,ybe],encapsulation:2,changeDetection:1})}return a})();var Ce=a=>({"docs-sample-code-tabs":a});var se=(()=>{class a{hideSampleCodeTabs=!0;sampleCodeButtonLabel=`Talk is cheap, show me the code!`;sampleCodeButtonIcon=`an an-plus`;toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?`Talk is cheap, show me the code!`:`Okay, hide the code`,this.sampleCodeButtonIcon=this.hideSampleCodeTabs?`an an-plus`:`an an-minus`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-labs-view`]],standalone:!1,decls:24,vars:6,consts:[[1,`sample-blockquote`],[1,`sample-title`,`po-font-text-large-bold`],[1,`show-me-the-code`,3,`click`],[3,`ngClass`],[`p-size`,`2`],[`p-label`,`HTML`,`p-active`,``],[1,`doc-label-path`],[`appCodeHighlight`,``,1,`html`],[`p-label`,`TS`],[`appCodeHighlight`,``,1,`typescript`],[1,`docs-sample-container`]],template:function(l,i){l&1&&(Gl(0,`br`),Tl(1,`blockquote`,0)(2,`label`,1),cN(3,`PO Login Labs`),ag(),Tl(4,`a`,2),ht(`click`,function(){return i.toggleSampleCodeTabs()}),Gl(5,`span`),cN(6),ag()(),Tl(7,`div`,3)(8,`po-tabs`,4)(9,`po-tab`,5)(10,`div`)(11,`label`,6),cN(12,`sample-po-login-labs/sample-po-login-labs.component.html`),ag(),Tl(13,`pre`,7),cN(14,`<po-login
  name="login"
  [(ngModel)]="login"
  [p-helper]="helperText"
...
`),ag()()(),Tl(15,`po-tab`,8)(16,`div`)(17,`label`,6),cN(18,`sample-po-login-labs/sample-po-login-labs.component.ts`),ag(),Tl(19,`pre`,9),cN(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),ag()()()()(),Tl(21,`div`,10),Gl(22,`sample-po-login-labs`),ag(),Gl(23,`hr`)),l&2&&(jp(5),Xx(`po-icon `+i.sampleCodeButtonIcon),jp(),hg(` `,i.sampleCodeButtonLabel),jp(),nw(`ngClass`,DN(4,Ce,i.hideSampleCodeTabs)))},dependencies:[PO,Ga,mCe,_Ce,pe],encapsulation:2,changeDetection:1})}return a})();var ce=(()=>{class a{poNotification=f(Eu);poModal;userLogin;userPassword;primaryAction={label:`Confirm`,action:()=>{this.confirmAction()}};openModal(){this.poModal.open()}cleanForm(){this.userLogin=``,this.userPassword=``}confirmAction(){this.userLogin&&this.userPassword&&(this.poNotification.success(`Discount successfully applied to user ${this.userLogin}!`),this.poModal.close(),this.cleanForm())}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-confirm`]],viewQuery:function(l,i){if(l&1&&Yl(vr,7),l&2){let s;lo(s=uo())&&(i.poModal=s.first)}},standalone:!1,decls:7,vars:3,consts:[[1,`po-text-center`],[1,`po-font-subtitle`],[`p-label`,`Confirm Identity`,3,`p-click`],[`p-hide-close`,`true`,`p-size`,`auto`,`p-title`,`Confirm your identity`,3,`p-primary-action`],[`name`,`userLogin`,`p-clean`,``,`p-label`,`User`,`p-maxlength`,`40`,`p-placeholder`,`domain\\user`,`p-required`,``,3,`ngModelChange`,`ngModel`],[`name`,`userPassword`,`p-clean`,``,`p-label`,`Password`,`p-placeholder`,`Enter your password`,`p-required`,``,3,`ngModelChange`,`ngModel`]],template:function(l,i){l&1&&(Tl(0,`div`,0)(1,`div`,1),cN(2,` To gain a 25% discount on your purchases, confirm your identity with your username and password! `),ag(),Tl(3,`po-button`,2),ht(`p-click`,function(){return i.openModal()}),ag()(),Tl(4,`po-modal`,3)(5,`po-login`,4),ww(`ngModelChange`,function(p){return uN(i.userLogin,p)||(i.userLogin=p),p}),ag(),a0(),Tl(6,`po-password`,5),ww(`ngModelChange`,function(p){return uN(i.userPassword,p)||(i.userPassword=p),p}),ag(),a0(),ag()),l&2&&(jp(4),nw(`p-primary-action`,i.primaryAction),jp(),Ew(`ngModel`,i.userLogin),l0(),jp(),Ew(`ngModel`,i.userPassword),l0())},dependencies:[gY,Ak,Zt,GH,hbe,vr],encapsulation:2,changeDetection:1})}return a})();var we=a=>({"docs-sample-code-tabs":a});var ue=(()=>{class a{hideSampleCodeTabs=!0;sampleCodeButtonLabel=`Talk is cheap, show me the code!`;sampleCodeButtonIcon=`an an-plus`;toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?`Talk is cheap, show me the code!`:`Okay, hide the code`,this.sampleCodeButtonIcon=this.hideSampleCodeTabs?`an an-plus`:`an an-minus`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-confirm-view`]],standalone:!1,decls:24,vars:6,consts:[[1,`sample-blockquote`],[1,`sample-title`,`po-font-text-large-bold`],[1,`show-me-the-code`,3,`click`],[3,`ngClass`],[`p-size`,`2`],[`p-label`,`HTML`,`p-active`,``],[1,`doc-label-path`],[`appCodeHighlight`,``,1,`html`],[`p-label`,`TS`],[`appCodeHighlight`,``,1,`typescript`],[1,`docs-sample-container`]],template:function(l,i){l&1&&(Gl(0,`br`),Tl(1,`blockquote`,0)(2,`label`,1),cN(3,`PO Login - Confirm Identity`),ag(),Tl(4,`a`,2),ht(`click`,function(){return i.toggleSampleCodeTabs()}),Gl(5,`span`),cN(6),ag()(),Tl(7,`div`,3)(8,`po-tabs`,4)(9,`po-tab`,5)(10,`div`)(11,`label`,6),cN(12,`sample-po-login-confirm/sample-po-login-confirm.component.html`),ag(),Tl(13,`pre`,7),cN(14,`<div class="po-text-center">
...
`),ag()()(),Tl(15,`po-tab`,8)(16,`div`)(17,`label`,6),cN(18,`sample-po-login-confirm/sample-po-login-confirm.component.ts`),ag(),Tl(19,`pre`,9),cN(20,`import { Component, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
...
Executada ao disparar o output `),Tl(1325,`code`),cN(1326,`change`),ag(),cN(1327,` ou `),Tl(1328,`code`),cN(1329,`change-model`),ag(),cN(1330,`, dependendo do valor da propriedade `),Tl(1331,`code`),cN(1332,`triggerMode`),ag(),cN(1333,`.`),ag()()(),Tl(1334,`tr`,15)(1335,`td`,16)(1336,`div`,24)(1337,`span`,25),cN(1338,` triggerMode`),Gl(1339,`br`),ag()()(),Tl(1340,`td`,20)(1341,`code`,39),cN(1342,`'change' `),ag(),Tl(1343,`code`,40),cN(1344,` 'changeModel'`),ag()(),Tl(1345,`td`,23)(1346,`em`)(1347,`strong`),cN(1348,`(opcional)`),ag()(),Tl(1349,`p`),cN(1350,`Controla se o método será executado no disparo do output `),Tl(1351,`code`),cN(1352,`change`),ag(),cN(1353,` ou `),Tl(1354,`code`),cN(1355,`change-model`),ag(),cN(1356,`.`),ag()()()()())},dependencies:[Ga],encapsulation:2,changeDetection:1})}return a})();var Me=[{path:``,component:(()=>{class a{route;router;sub;hidePoWebSample=!0;samplesLength=3;activeTab=`doc`;actions=[{label:`Documentação`,action:this.goBack.bind(this),icon:`an an-file-text`},{label:`Colabore`,action:this.improveDocs.bind(this)}];constructor(d,l){this.route=d,this.router=l}goBack(){this.router.navigate([`documentation`])}improveDocs(){this.router.navigate([`guides/development-flow`])}ngOnInit(){this.sub=this.route.queryParams.subscribe(d=>{let l=d.view;this.activeTab=l||`doc`,this.hidePoWebSample=this.samplesLength===0})}changeTab(d){this.router.navigate([],{queryParams:{view:d},queryParamsHandling:`merge`}),this.activeTab=d}ngOnDestroy(){this.sub.unsubscribe()}static ɵfac=function(l){return new(l||a)(w(Xn),w(Cn))};static ɵcmp=Un({type:a,selectors:[[`ng-component`]],standalone:!1,decls:8,vars:4,consts:[[`p-title`,`Login`,3,`p-actions`],[`p-size`,`1`],[`p-label`,`Documentação`,3,`p-click`,`p-active`],[`p-label`,`Exemplos`,3,`p-click`,`p-hide`,`p-active`]],template:function(l,i){l&1&&(Tl(0,`po-page-default`,0)(1,`po-tabs`,1)(2,`po-tab`,2),ht(`p-click`,function(){return i.changeTab(`doc`)}),Gl(3,`sample-po-login-doc`),ag(),Tl(4,`po-tab`,3),ht(`p-click`,function(){return i.changeTab(`web`)}),Gl(5,`sample-po-login-basic-view`)(6,`sample-po-login-labs-view`)(7,`sample-po-login-confirm-view`),ag()()()),l&2&&(nw(`p-actions`,i.actions),jp(2),nw(`p-active`,i.activeTab===`doc`),jp(2),nw(`p-hide`,i.hidePoWebSample)(`p-active`,i.activeTab===`web`))},dependencies:[S8e,mCe,_Ce,de,se,ue,Ee],encapsulation:2,changeDetection:1})}return a})()}];var Se=(()=>{class a{static ɵfac=function(l){return new(l||a)};static ɵmod=he({type:a});static ɵinj=ue$1({imports:[bL.forChild(Me),bL]})}return a})();var ot=(()=>{class a{static ɵfac=function(l){return new(l||a)};static ɵmod=he({type:a});static ɵinj=ue$1({imports:[ar,Se]})}return a})();export{ot as DocPoLoginModule};