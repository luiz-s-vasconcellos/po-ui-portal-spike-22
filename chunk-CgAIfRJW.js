...
`),sg()()()()(),Tl(21,"div",10),Gl(22,"sample-po-code-editor-labs"),sg(),Gl(23,"hr")),i&2&&(Vp(5),qx("po-icon "+a.sampleCodeButtonIcon),Vp(),fg(" ",a.sampleCodeButtonLabel),Vp(),nw("ngClass",mN(4,be,a.hideSampleCodeTabs)));},dependencies:[AO,Ka,Ume,$me,ne],encapsulation:2,changeDetection:1})}return n})();var ae=(()=>{class n{code=[`class Calc {
