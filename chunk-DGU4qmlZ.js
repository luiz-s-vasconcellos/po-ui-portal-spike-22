import{$r as Vx,An as wbe,Et as V8e,F as G4,Ft as ZH,Hr as Tw,Ii as ht,Ir as Qy,It as Zt,Jn as CY,Ki as lo,Kr as Un,M as ECe,Mi as gg,Mn as xbe,Ni as he,P as Eu,Qi as oN,Sa as yN,Ti as f0,Ui as lg,Vi as kk,Xn as Cn,Yi as mN,Zr as Vk,_r as Ml,ar as IY,bi as cw,br as NL,cn as lU,da as uo,ea as p0,ga as w,kn as vr,l as ar,mn as q0e,mr as MN,nr as HO,oa as ql,on as kbe,qr as Up,r as Ga,ri as Xn,sr as Jy,ua as ue$1,ui as Zl,un as nb,va as wY,vr as Mw,vt as SCe,wi as f}from"./main-NT5YGKBQ.js";var re=(()=>{class a{static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-basic`]],standalone:!1,decls:1,vars:0,consts:[[`name`,`login`,`p-label`,`PO Login`]],template:function(l,i){l&1&&ql(0,`po-login`,0)},dependencies:[ZH],encapsulation:2,changeDetection:1})}return a})();var be=a=>({"docs-sample-code-tabs":a});var de=(()=>{class a{hideSampleCodeTabs=!0;sampleCodeButtonLabel=`Talk is cheap, show me the code!`;sampleCodeButtonIcon=`an an-plus`;toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?`Talk is cheap, show me the code!`:`Okay, hide the code`,this.sampleCodeButtonIcon=this.hideSampleCodeTabs?`an an-plus`:`an an-minus`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-basic-view`]],standalone:!1,decls:24,vars:6,consts:[[1,`sample-blockquote`],[1,`sample-title`,`po-font-text-large-bold`],[1,`show-me-the-code`,3,`click`],[3,`ngClass`],[`p-size`,`2`],[`p-label`,`HTML`,`p-active`,``],[1,`doc-label-path`],[`appCodeHighlight`,``,1,`html`],[`p-label`,`TS`],[`appCodeHighlight`,``,1,`typescript`],[1,`docs-sample-container`]],template:function(l,i){l&1&&(ql(0,`br`),Ml(1,`blockquote`,0)(2,`label`,1),mN(3,`PO Login Basic`),lg(),Ml(4,`a`,2),ht(`click`,function(){return i.toggleSampleCodeTabs()}),ql(5,`span`),mN(6),lg()(),Ml(7,`div`,3)(8,`po-tabs`,4)(9,`po-tab`,5)(10,`div`)(11,`label`,6),mN(12,`sample-po-login-basic/sample-po-login-basic.component.html`),lg(),Ml(13,`pre`,7),mN(14,`<po-login name="login" p-label="PO Login"> </po-login>
`),lg()()(),Ml(15,`po-tab`,8)(16,`div`)(17,`label`,6),mN(18,`sample-po-login-basic/sample-po-login-basic.component.ts`),lg(),Ml(19,`pre`,9),mN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),lg()()(),Ml(15,`po-tab`,8)(16,`div`)(17,`label`,6),mN(18,`sample-po-login-labs/sample-po-login-labs.component.ts`),lg(),Ml(19,`pre`,9),mN(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),lg()()()()(),Ml(21,`div`,10),ql(22,`sample-po-login-labs`),lg(),ql(23,`hr`)),l&2&&(Up(5),oN(`po-icon `+i.sampleCodeButtonIcon),Up(),gg(` `,i.sampleCodeButtonLabel),Up(),cw(`ngClass`,MN(4,Ce,i.hideSampleCodeTabs)))},dependencies:[HO,Ga,SCe,ECe,pe],encapsulation:2,changeDetection:1})}return a})();var ce=(()=>{class a{poNotification=f(Eu);poModal;userLogin;userPassword;primaryAction={label:`Confirm`,action:()=>{this.confirmAction()}};openModal(){this.poModal.open()}cleanForm(){this.userLogin=``,this.userPassword=``}confirmAction(){this.userLogin&&this.userPassword&&(this.poNotification.success(`Discount successfully applied to user ${this.userLogin}!`),this.poModal.close(),this.cleanForm())}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-confirm`]],viewQuery:function(l,i){if(l&1&&Zl(vr,7),l&2){let s;lo(s=uo())&&(i.poModal=s.first)}},standalone:!1,decls:7,vars:3,consts:[[1,`po-text-center`],[1,`po-font-subtitle`],[`p-label`,`Confirm Identity`,3,`p-click`],[`p-hide-close`,`true`,`p-size`,`auto`,`p-title`,`Confirm your identity`,3,`p-primary-action`],[`name`,`userLogin`,`p-clean`,``,`p-label`,`User`,`p-maxlength`,`40`,`p-placeholder`,`domain\\user`,`p-required`,``,3,`ngModelChange`,`ngModel`],[`name`,`userPassword`,`p-clean`,``,`p-label`,`Password`,`p-placeholder`,`Enter your password`,`p-required`,``,3,`ngModelChange`,`ngModel`]],template:function(l,i){l&1&&(Ml(0,`div`,0)(1,`div`,1),mN(2,` To gain a 25% discount on your purchases, confirm your identity with your username and password! `),lg(),Ml(3,`po-button`,2),ht(`p-click`,function(){return i.openModal()}),lg()(),Ml(4,`po-modal`,3)(5,`po-login`,4),Mw(`ngModelChange`,function(p){return yN(i.userLogin,p)||(i.userLogin=p),p}),lg(),f0(),Ml(6,`po-password`,5),Mw(`ngModelChange`,function(p){return yN(i.userPassword,p)||(i.userPassword=p),p}),lg(),f0(),lg()),l&2&&(Up(4),cw(`p-primary-action`,i.primaryAction),Up(),Tw(`ngModel`,i.userLogin),p0(),Up(),Tw(`ngModel`,i.userPassword),p0())},dependencies:[wY,Vk,Zt,ZH,wbe,vr],encapsulation:2,changeDetection:1})}return a})();var we=a=>({"docs-sample-code-tabs":a});var ue=(()=>{class a{hideSampleCodeTabs=!0;sampleCodeButtonLabel=`Talk is cheap, show me the code!`;sampleCodeButtonIcon=`an an-plus`;toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?`Talk is cheap, show me the code!`:`Okay, hide the code`,this.sampleCodeButtonIcon=this.hideSampleCodeTabs?`an an-plus`:`an an-minus`}static ɵfac=function(l){return new(l||a)};static ɵcmp=Un({type:a,selectors:[[`sample-po-login-confirm-view`]],standalone:!1,decls:24,vars:6,consts:[[1,`sample-blockquote`],[1,`sample-title`,`po-font-text-large-bold`],[1,`show-me-the-code`,3,`click`],[3,`ngClass`],[`p-size`,`2`],[`p-label`,`HTML`,`p-active`,``],[1,`doc-label-path`],[`appCodeHighlight`,``,1,`html`],[`p-label`,`TS`],[`appCodeHighlight`,``,1,`typescript`],[1,`docs-sample-container`]],template:function(l,i){l&1&&(ql(0,`br`),Ml(1,`blockquote`,0)(2,`label`,1),mN(3,`PO Login - Confirm Identity`),lg(),Ml(4,`a`,2),ht(`click`,function(){return i.toggleSampleCodeTabs()}),ql(5,`span`),mN(6),lg()(),Ml(7,`div`,3)(8,`po-tabs`,4)(9,`po-tab`,5)(10,`div`)(11,`label`,6),mN(12,`sample-po-login-confirm/sample-po-login-confirm.component.html`),lg(),Ml(13,`pre`,7),mN(14,`<div class="po-text-center">
...
`),lg()()(),Ml(15,`po-tab`,8)(16,`div`)(17,`label`,6),mN(18,`sample-po-login-confirm/sample-po-login-confirm.component.ts`),lg(),Ml(19,`pre`,9),mN(20,`import { Component, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
