import {f as fe,u as ue,a as ar,b as vL,w,c3 as Xn,d as wn,U as Un,aW as Yp,b8 as Hme,cC as hNe,T as Tl,J as Gl,L as sg,an as TO,aH as Ga,b9 as Gme,z as tN,a1 as ht,F as Vp,ar as zx,au as fg,M as tw,bs as hN,aF as J9,aG as Ck,b0 as Qt,b1 as mv,b2 as Zhe,c8 as Sde,aB as Cx,aQ as mx,cF as px,aM as Ew,aN as t0,bd as Ox,aS as vx,aO as Dw,aP as r0,av as Yl,aw as uo,ax as fo,aX as nY,aY as eY,aZ as Dk,bD as Mde,b4 as O3,aJ as Uhe,c9 as $he,cn as r3,ab as lt,a3 as aNe,ba as gNe,cG as jO,aD as Ky,aA as Rx,aE as Xy,a4 as _N,cH as sN,a6 as wN,br as aN,H as vw,aT as rN}from'./main-LUSFEIN7.js';var Te=(()=>{class l{static \u0275fac=function(i){return new(i||l)};static \u0275cmp=Un({type:l,selectors:[["sample-po-context-tabs-basic"]],standalone:false,decls:3,vars:0,consts:[["p-label","PO Tabs 1"],["p-label","PO Tabs 2"]],template:function(i,o){i&1&&(Tl(0,"po-context-tabs"),Gl(1,"po-tab",0)(2,"po-tab",1),sg());},dependencies:[Hme,hNe],encapsulation:2,changeDetection:1})}return l})();var We=l=>({"docs-sample-code-tabs":l}),xe=(()=>{class l{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(i){return new(i||l)};static \u0275cmp=Un({type:l,selectors:[["sample-po-context-tabs-basic-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(i,o){i&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),tN(3,"PO Context Tabs Basic"),sg(),Tl(4,"a",2),ht("click",function(){return o.toggleSampleCodeTabs()}),Gl(5,"span"),tN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),tN(12,"sample-po-context-tabs-basic/sample-po-context-tabs-basic.component.html"),sg(),Tl(13,"pre",7),tN(14,`<po-context-tabs>
  <po-tab p-label="PO Tabs 1"></po-tab>
  <po-tab p-label="PO Tabs 2"></po-tab>
</po-context-tabs>
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),tN(18,"sample-po-context-tabs-basic/sample-po-context-tabs-basic.component.ts"),sg(),Tl(19,"pre",9),tN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()()()(),Tl(21,"div",10),Gl(22,"sample-po-context-tabs-basic"),sg(),Gl(23,"hr")),i&2&&(Vp(5),zx("po-icon "+o.sampleCodeButtonIcon),Vp(),fg(" ",o.sampleCodeButtonLabel),Vp(),tw("ngClass",hN(4,We,o.hideSampleCodeTabs)));},dependencies:[TO,Ga,Hme,Gme,Te],encapsulation:2})}return l})();var qe=["poTab"];function Le(l,O){if(l&1){let a=Cx();Tl(0,"po-tab",9),ht("p-click",function(){let o=Ky(a).$implicit,d=Rx();return Xy(d.onClick(o))})("p-close-tab",function(){let o=Ky(a).$implicit,d=Rx();return Xy(d.onClose(o))}),Tl(1,"div",10),tN(2),sg()();}if(l&2){let a=O.$implicit,i=O.$index;tw("p-active",a.active)("p-disabled",a.disabled)("p-hide",a.hide)("p-hide-close",a.hideClose)("p-label",a.label),Vp(2),fg("Tab Content ",i);}}var ye=(()=>{class l{poNotification;poTab;tabsFieldsForm=[{property:"label",divider:"TAB",required:true,gridColumns:4},{property:"click",gridColumns:4},{property:"closeTab",label:"Close Tab",gridColumns:4},{property:"active",type:"boolean",gridColumns:3},{property:"disabled",type:"boolean",gridColumns:3},{property:"hide",type:"boolean",gridColumns:3},{property:"hideClose",label:"Hide Close",type:"boolean",gridColumns:3}];sizeOptions=[{label:"small",value:"small"},{label:"medium",value:"medium"}];size="medium";tabs=[];properties=[];pageWidth;constructor(a){this.poNotification=a;}ngOnInit(){this.restore(),this.pageWidth=window.innerWidth;}addTab(a){let i=Object.assign({},a);i.click=i.click?this.showClick.bind(this,i.click):void 0,i.closeTab=i.closeTab?this.dispachClose.bind(this,i.closeTab):void 0,this.tabs.push(i),this.tabs.length<=4?this.poTab.setQuantityTabsButton(this.tabs.length):this.tabs.length>4&&this.poTab.setQuantityTabsButton(4);}onClick(a){a.click&&a.click();}onClose(a){a.closeTab&&a.closeTab();}restore(){this.size="medium",this.tabs=[],this.poTab.quantityTabsButton=0;}showClick(a){this.poNotification.success(`Action clicked: ${a}`);}dispachClose(a){this.poNotification.success(`Action closed: ${a}`);}static \u0275fac=function(i){return new(i||l)(w(Yp))};static \u0275cmp=Un({type:l,selectors:[["sample-po-context-tabs-labs"]],viewQuery:function(i,o){if(i&1&&Yl(qe,7),i&2){let d;uo(d=fo())&&(o.poTab=d.first);}},standalone:false,decls:12,vars:6,consts:[["poTab",""],["tabsForm",""],[3,"p-size"],[3,"p-active","p-disabled","p-hide","p-hide-close","p-label"],[3,"p-fields","p-value"],[1,"po-row"],["p-label","Add Tab",1,"po-md-3",3,"p-click","p-disabled"],["name","size","p-columns","4","p-label","Size","p-help","Para aplicar o tamanho small, configure o n\xEDvel de acessibilidade para AA, ajust\xE1vel no navbar ou servi\xE7o de tema (https://po-ui.io/documentation/po-theme).",1,"po-md-12",3,"ngModelChange","ngModel","p-options"],["p-label","Sample Restore",1,"po-md-3",3,"p-click"],[3,"p-click","p-close-tab","p-active","p-disabled","p-hide","p-hide-close","p-label"],[1,"po-font-subtitle"]],template:function(i,o){if(i&1){let d=Cx();Tl(0,"po-context-tabs",2,0),mx(2,Le,3,6,"po-tab",3,px),sg(),Gl(4,"po-dynamic-form",4,1),Tl(6,"div",5)(7,"po-button",6),ht("p-click",function(){Ky(d);let r=Ox(5);return o.addTab(r.form.value),Xy(r.form.reset())}),sg()(),Gl(8,"po-divider"),Tl(9,"po-radio-group",7),Ew("ngModelChange",function(r){return Ky(d),rN(o.size,r)||(o.size=r),Xy(r)}),sg(),t0(),Tl(10,"div",5)(11,"po-button",8),ht("p-click",function(){return o.restore()}),sg()();}if(i&2){let d=Ox(5);tw("p-size",o.size),Vp(2),vx(o.tabs),Vp(2),tw("p-fields",o.tabsFieldsForm)("p-value",o.tabs),Vp(3),tw("p-disabled",d.form.invalid),Vp(2),Dw("ngModel",o.size),tw("p-options",o.sizeOptions),r0();}},dependencies:[J9,Ck,Qt,mv,Zhe,Sde,Hme,hNe],encapsulation:2,changeDetection:1})}return l})();var ze=l=>({"docs-sample-code-tabs":l}),Ee=(()=>{class l{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(i){return new(i||l)};static \u0275cmp=Un({type:l,selectors:[["sample-po-context-tabs-labs-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(i,o){i&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),tN(3,"PO Context Tabs Labs"),sg(),Tl(4,"a",2),ht("click",function(){return o.toggleSampleCodeTabs()}),Gl(5,"span"),tN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),tN(12,"sample-po-context-tabs-labs/sample-po-context-tabs-labs.component.html"),sg(),Tl(13,"pre",7),tN(14,`<po-context-tabs #poTab [p-size]="size">
...
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),tN(18,"sample-po-context-tabs-labs/sample-po-context-tabs-labs.component.ts"),sg(),Tl(19,"pre",9),tN(20,`import { Component, OnInit, ViewChild, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()()()(),Tl(21,"div",10),Gl(22,"sample-po-context-tabs-labs"),sg(),Gl(23,"hr")),i&2&&(Vp(5),zx("po-icon "+o.sampleCodeButtonIcon),Vp(),fg(" ",o.sampleCodeButtonLabel),Vp(),tw("ngClass",hN(4,ze,o.hideSampleCodeTabs)));},dependencies:[TO,Ga,Hme,Gme,ye],encapsulation:2})}return l})();var we=(()=>{class l{poNotificationService;card;cardName;classFlight;classTrain;cvv;departDate;destination;expiryMonth;expiryYear;flightCompany;origin;returnDate;totalCost;trainCompany;transportation;classFlightOptions=[{label:"Economy",value:1},{label:"Business",value:2},{label:"Comfort",value:3},{label:"First Class",value:4}];classTrainOptions=[{label:"Economy",value:1},{label:"Cabin",value:2},{label:"First Class",value:3}];flightCompanyOptions=[{label:"American Airlines",value:"american"},{label:"Avianca",value:"avianca"},{label:"Delta Airlines",value:"delta"},{label:"Emirates",value:"emirates"},{label:"Latam",value:"latam"}];trainCompanyOptions=[{label:"EuroStar",value:"eurostar"},{label:"OBB",value:"obb"},{label:"Renfe",value:"renfe"},{label:"TrenItalia",value:"trenitalia"}];transportationOptions=[{label:"Flights",value:"flight"},{label:"Trains",value:"train"}];constructor(a){this.poNotificationService=a;}bankBillet(){this.poNotificationService.warning("Bank billet sent to email");}isPaymentEnable(a,i,o){return a.valid&&this.transportation==="flight"&&o.valid||a.valid&&this.transportation==="train"&&i.valid}getTotalCost(){return this.transportation==="flight"&&this.classFlight?(this.totalCost=800*this.classFlight,`$${this.totalCost}`):this.transportation==="train"&&this.classTrain?(this.totalCost=300*this.classTrain,`$${this.totalCost}`):(this.totalCost=void 0,"Fields are missing")}payment(){this.poNotificationService.success("Order confirmed");}static \u0275fac=function(i){return new(i||l)(w(Yp))};static \u0275cmp=Un({type:l,selectors:[["sample-po-context-tabs-travel"]],standalone:false,decls:47,vars:30,consts:[["formTravel","ngForm"],["formTrain","ngForm"],["formFlight","ngForm"],["formCreditCard","ngForm"],["p-active","","p-label","Destination"],[1,"po-row"],["name","origin","p-label","Origin","p-required","",1,"po-lg-12",3,"ngModelChange","ngModel"],["name","destination","p-label","Destination","p-required","",1,"po-lg-12",3,"ngModelChange","ngModel"],["name","departDate","p-label","Depart","p-required","",1,"po-md-6",3,"ngModelChange","ngModel"],["name","returnDate","p-label","Return","p-required","",1,"po-md-6",3,"ngModelChange","ngModel","p-min-date"],["name","transportation","p-label","Transportation","p-required","",1,"po-lg-12",3,"ngModelChange","ngModel","p-options"],["p-label","Trains",3,"p-hide","p-hide-close"],["name","trainCompany","p-label","Tran Company","p-required","",1,"po-lg-12",3,"ngModelChange","ngModel","p-options"],["name","classTrain","p-label","Class","p-required","",1,"po-lg-12",3,"ngModelChange","ngModel","p-options"],["p-label","Flights",3,"p-hide","p-hide-close"],["name","flightCompany","p-label","Flight Company","p-required","",1,"po-lg-12",3,"ngModelChange","ngModel","p-options"],["name","classFlight","p-label","Class","p-required","",1,"po-lg-12",3,"ngModelChange","ngModel","p-options"],["p-label","Payment",3,"p-disabled","p-hide-close"],["p-label","Total Cost",1,"po-md-6",3,"p-value"],["p-active","","p-label","Credit Card"],["name","cardName","p-clean","","p-label","Name on Card","p-required","",1,"po-md-8","po-lg-6",3,"ngModelChange","ngModel"],["name","card","p-clean","","p-label","Card Number","p-mask","9999 9999 9999 9999","p-required","",1,"po-md-8","po-lg-6",3,"ngModelChange","ngModel"],["name","expiryMonth","p-clean","","p-label","Expiry Month","p-mask","19","p-required","",1,"po-md-2",3,"ngModelChange","ngModel"],["name","expiryYear","p-clean","","p-label","Year","p-mask","2999","p-required","",1,"po-md-2",3,"ngModelChange","ngModel"],["name","cvv","p-clean","","p-label","CVV","p-mask","9999","p-required","",1,"po-md-2",3,"ngModelChange","ngModel"],["p-label","Pay now",1,"po-md-3",3,"p-click","p-disabled"],["p-label","Bank Billet",3,"p-hide-close"],["p-label","Generate Bank Billet",1,"po-md-4",3,"p-click","p-disabled"]],template:function(i,o){if(i&1){let d=Cx();Tl(0,"po-context-tabs")(1,"po-tab",4)(2,"form",null,0)(4,"div",5)(5,"po-input",6),Ew("ngModelChange",function(r){return Ky(d),rN(o.origin,r)||(o.origin=r),Xy(r)}),sg(),t0(),sg(),Tl(6,"div",5)(7,"po-input",7),Ew("ngModelChange",function(r){return Ky(d),rN(o.destination,r)||(o.destination=r),Xy(r)}),sg(),t0(),sg(),Tl(8,"div",5)(9,"po-datepicker",8),Ew("ngModelChange",function(r){return Ky(d),rN(o.departDate,r)||(o.departDate=r),Xy(r)}),sg(),t0(),Tl(10,"po-datepicker",9),Ew("ngModelChange",function(r){return Ky(d),rN(o.returnDate,r)||(o.returnDate=r),Xy(r)}),sg(),t0(),sg(),Tl(11,"div",5)(12,"po-radio-group",10),Ew("ngModelChange",function(r){return Ky(d),rN(o.transportation,r)||(o.transportation=r),Xy(r)}),sg(),t0(),sg()()(),Tl(13,"po-tab",11)(14,"form",null,1)(16,"div",5)(17,"po-select",12),Ew("ngModelChange",function(r){return Ky(d),rN(o.trainCompany,r)||(o.trainCompany=r),Xy(r)}),sg(),t0(),sg(),Tl(18,"div",5)(19,"po-select",13),Ew("ngModelChange",function(r){return Ky(d),rN(o.classTrain,r)||(o.classTrain=r),Xy(r)}),sg(),t0(),sg()()(),Tl(20,"po-tab",14)(21,"form",null,2)(23,"div",5)(24,"po-select",15),Ew("ngModelChange",function(r){return Ky(d),rN(o.flightCompany,r)||(o.flightCompany=r),Xy(r)}),sg(),t0(),sg(),Tl(25,"div",5)(26,"po-select",16),Ew("ngModelChange",function(r){return Ky(d),rN(o.classFlight,r)||(o.classFlight=r),Xy(r)}),sg(),t0(),sg()()(),Tl(27,"po-tab",17)(28,"div",5),Gl(29,"po-info",18),sg(),Tl(30,"po-context-tabs")(31,"po-tab",19)(32,"form",null,3)(34,"div",5)(35,"po-input",20),Ew("ngModelChange",function(r){return Ky(d),rN(o.cardName,r)||(o.cardName=r),Xy(r)}),sg(),t0(),sg(),Tl(36,"div",5)(37,"po-input",21),Ew("ngModelChange",function(r){return Ky(d),rN(o.card,r)||(o.card=r),Xy(r)}),sg(),t0(),sg(),Tl(38,"div",5)(39,"po-input",22),Ew("ngModelChange",function(r){return Ky(d),rN(o.expiryMonth,r)||(o.expiryMonth=r),Xy(r)}),sg(),t0(),Tl(40,"po-input",23),Ew("ngModelChange",function(r){return Ky(d),rN(o.expiryYear,r)||(o.expiryYear=r),Xy(r)}),sg(),t0(),Tl(41,"po-input",24),Ew("ngModelChange",function(r){return Ky(d),rN(o.cvv,r)||(o.cvv=r),Xy(r)}),sg(),t0(),sg(),Tl(42,"div",5)(43,"po-button",25),ht("p-click",function(){return o.payment()}),sg()()()(),Tl(44,"po-tab",26)(45,"div",5)(46,"po-button",27),ht("p-click",function(){return o.bankBillet()}),sg()()()()()();}if(i&2){let d=Ox(3),C=Ox(15),r=Ox(22),Fe=Ox(33);Vp(5),Dw("ngModel",o.origin),r0(),Vp(2),Dw("ngModel",o.destination),r0(),Vp(2),Dw("ngModel",o.departDate),r0(),Vp(),Dw("ngModel",o.returnDate),tw("p-min-date",o.departDate),r0(),Vp(2),Dw("ngModel",o.transportation),tw("p-options",o.transportationOptions),r0(),Vp(),tw("p-hide",o.transportation!=="train")("p-hide-close",true),Vp(4),Dw("ngModel",o.trainCompany),tw("p-options",o.trainCompanyOptions),r0(),Vp(2),Dw("ngModel",o.classTrain),tw("p-options",o.classTrainOptions),r0(),Vp(),tw("p-hide",o.transportation!=="flight")("p-hide-close",true),Vp(4),Dw("ngModel",o.flightCompany),tw("p-options",o.flightCompanyOptions),r0(),Vp(2),Dw("ngModel",o.classFlight),tw("p-options",o.classFlightOptions),r0(),Vp(),tw("p-disabled",o.isPaymentEnable(d,C,r)===false)("p-hide-close",true),Vp(2),tw("p-value",o.getTotalCost()),Vp(6),Dw("ngModel",o.cardName),r0(),Vp(2),Dw("ngModel",o.card),r0(),Vp(2),Dw("ngModel",o.expiryMonth),r0(),Vp(),Dw("ngModel",o.expiryYear),r0(),Vp(),Dw("ngModel",o.cvv),r0(),Vp(2),tw("p-disabled",!Fe.form.valid||!o.totalCost),Vp(),tw("p-hide-close",true),Vp(2),tw("p-disabled",!o.totalCost);}},dependencies:[nY,J9,eY,Ck,Dk,Qt,Mde,O3,Sde,Uhe,$he,Hme,hNe],encapsulation:2,changeDetection:1})}return l})();var He=l=>({"docs-sample-code-tabs":l}),_e=(()=>{class l{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(i){return new(i||l)};static \u0275cmp=Un({type:l,selectors:[["sample-po-context-tabs-travel-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(i,o){i&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),tN(3,"PO Context Tabs - Travel"),sg(),Tl(4,"a",2),ht("click",function(){return o.toggleSampleCodeTabs()}),Gl(5,"span"),tN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),tN(12,"sample-po-context-tabs-travel/sample-po-context-tabs-travel.component.html"),sg(),Tl(13,"pre",7),tN(14,`<po-context-tabs>
...
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),tN(18,"sample-po-context-tabs-travel/sample-po-context-tabs-travel.component.ts"),sg(),Tl(19,"pre",9),tN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),tN(18,"sample-po-context-tabs-business-conf/sample-po-context-tabs-business-conf.component.ts"),sg(),Tl(19,"pre",9),tN(20,`import { Component, OnInit, ViewChild, ChangeDetectionStrategy } from '@angular/core';
...
Caso uma aba estiver desabilitada, n\xE3o receber\xE1 foco de navega\xE7\xE3o.`),sg(),Tl(255,"h4"),tN(256,"Boas pr\xE1ticas"),sg(),Tl(257,"ul")(258,"li"),tN(259,"Evite utilizar um "),Tl(260,"code"),tN(261,"po-context-tabs"),sg(),tN(262," dentro de outro "),Tl(263,"code"),tN(264,"po-context-tabs"),sg(),tN(265,";"),sg(),Tl(266,"li"),tN(267,"Evite utilizar uma quantidade excessiva de abas, pois ir\xE1 gerar um "),Tl(268,"em"),tN(269,"scroll"),sg(),tN(270," muito longo no "),Tl(271,"code"),tN(272,"dropdown"),sg(),tN(273,";"),sg(),Tl(274,"li"),tN(275,"Evite "),Tl(276,"code"),tN(277,"labels"),sg(),tN(278," extensos para as "),Tl(279,"code"),tN(280,"tabs"),sg(),tN(281," pois podem quebrar seu "),Tl(282,"em"),tN(283,"layout"),sg(),tN(284,", use "),Tl(285,"code"),tN(286,"labels"),sg(),tN(287," diretas, curtas e intuitivas."),sg()()(),Tl(288,"div",8)(289,"h4",9),tN(290,"Seletor"),sg(),Tl(291,"pre",10),tN(292,`<po-context-tabs
    p-size="string" >
</po-context-tabs>
...
Para mais detalhes, consulte a documenta\xE7\xE3o do `),Tl(339,"a",23),tN(340,"po-theme"),sg(),tN(341,"."),sg()()()()(),Tl(342,"h3",11),tN(343,"M\xE9todos"),sg(),Tl(344,"table",24)(345,"tr",15)(346,"th",25)(347,"div",17)(348,"h4")(349,"span",18),tN(350," setQuantityTabsButton "),sg()()()()(),Tl(351,"tr",22)(352,"td",22)(353,"p"),tN(354,"Fun\xE7\xE3o que atribui o n\xFAmero de tabs fora do dropdown."),sg(),Tl(355,"p"),tN(356,"Para utiliz\xE1-la \xE9 necess\xE1rio ter a inst\xE2ncia do componente no DOM, podendo ser utilizado o ViewChild da seguinte forma:"),sg(),Tl(357,"pre")(358,"code"),tN(359,`import { PoContextTabsComponent } from '@po-ui/ng-components';
