import {f as fe$1,u as ue$1,s as sr,m as mL,w,c3 as Xn,E as En,U as Un,a as r$1,dL as gNe,F as Wl,O as rw,bs as gN,a7 as pN,an as SO,aH as Ka,b8 as Ume,b9 as $me,C as Sl,y as rN,J as og,a1 as ft,L as Lp,ar as Gx,au as dg,aX as Q9,aF as Z9,aY as K9,aG as wk,aZ as _k,b0 as Qt,b1 as mv,c4 as b3,b4 as L3,c8 as Tde,aJ as Whe,bH as k3,c9 as jhe,aB as Ix,aM as Cw,aN as n0,bd as kx,aO as ww,aP as i0,a3 as sNe,ab as lt,d8 as Lme,d9 as hNe,b7 as M3,ba as vNe,av as ql,aw as lo,ax as uo,aD as Ky,aT as oN,aE as Xy}from'./main-LEW6T6YX.js';var ye=()=>({label:"Adicionar",value:1.1}),ue=a=>[a],xe=a=>({label:"Gerenciador de usu\xE1rios",value:1,subItems:a}),be=(()=>{class a{static \u0275fac=function(o){return new(o||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-tree-view-basic"]],standalone:false,decls:1,vars:8,consts:[[3,"p-items"]],template:function(o,i){o&1&&Wl(0,"po-tree-view",0),o&2&&rw("p-items",gN(6,ue,gN(4,xe,gN(2,ue,pN(1,ye)))));},dependencies:[gNe],encapsulation:2,changeDetection:1})}return a})();var Ie=a=>({"docs-sample-code-tabs":a}),ve=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(o){return new(o||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-tree-view-basic-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(o,i){o&1&&(Wl(0,"br"),Sl(1,"blockquote",0)(2,"label",1),rN(3,"PO Tree View Basic"),og(),Sl(4,"a",2),ft("click",function(){return i.toggleSampleCodeTabs()}),Wl(5,"span"),rN(6),og()(),Sl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),rN(12,"sample-po-tree-view-basic/sample-po-tree-view-basic.component.html"),og(),Sl(13,"pre",7),rN(14,`<po-tree-view
  [p-items]="[{ label: 'Gerenciador de usu\xE1rios', value: 1, subItems: [{ label: 'Adicionar', value: 1.1 }] }]"
>
</po-tree-view>
`),og()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),rN(18,"sample-po-tree-view-basic/sample-po-tree-view-basic.component.ts"),og(),Sl(19,"pre",9),rN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),og()()()()(),Sl(21,"div",10),Wl(22,"sample-po-tree-view-basic"),og(),Wl(23,"hr")),o&2&&(Lp(5),Gx("po-icon "+i.sampleCodeButtonIcon),Lp(),dg(" ",i.sampleCodeButtonLabel),Lp(),rw("ngClass",gN(4,Ie,i.hideSampleCodeTabs)));},dependencies:[SO,Ka,Ume,$me,be],encapsulation:2,changeDetection:1})}return a})();var he=(()=>{class a{componentsSize="medium";event;items;itemProperties;parent;parentList;selectable;treeViewItem;maxLevel=4;singleSelect=false;componentsSizeOptions=[{value:"small",label:"Small"},{value:"medium",label:"Medium"}];itemPropertiesOptions=[{value:"selected",label:"Selected"},{value:"expanded",label:"Expanded"},{value:"disable-selection",label:"Disable Selection"}];ngOnInit(){this.restore();}add(r){r.selected=this.itemProperties.includes("selected"),r.expanded=this.itemProperties.includes("expanded"),r.isSelectable=!this.itemProperties.includes("disable-selection");let o=r$1({},r);if(!this.parent)this.items=[...this.items,o];else {let i=this.getTreeViewItemNode(this.items,this.parent);i.subItems||(i.subItems=[]),i.subItems=[...i.subItems,o];}this.items=[].concat(this.items),this.parentList=this.updateParentList(this.items);}changeEvent(r,o){this.event=`${r}: ${JSON.stringify(o)}`;}restore(){this.componentsSize="medium",this.event=void 0,this.items=[],this.parent=void 0,this.parentList=[],this.itemProperties=[],this.selectable=void 0,this.treeViewItem={},this.maxLevel=4;}getTreeViewItemNode(r,o){let i;if(r){for(let m of r)if(m.value===o){i=m;break}else i||(i=this.getTreeViewItemNode(m.subItems,o));return i}}updateParentList(r,o=0,i=[],m){return r.forEach(c=>{let{label:p,value:Ve}=c;i.push({label:`${"-".repeat(o)} ${p}`,value:Ve}),c.subItems&&(this.updateParentList(c.subItems,++o,i,c),--o),o=m?o:0;}),i}static \u0275fac=function(o){return new(o||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-tree-view-labs"]],standalone:false,decls:24,vars:18,consts:[["treeViewItemForm","ngForm"],[3,"p-collapsed","p-expanded","p-selected","p-unselected","p-components-size","p-items","p-selectable","p-max-level","p-single-select"],["p-label","Events"],[1,"po-row"],["p-label","Event",3,"p-value"],["p-label","Po Tree View Config"],["name","level","p-label","Max Level",1,"po-md-6","po-lg-3",3,"ngModelChange","ngModel"],["name","selectable","p-label","Selectable",1,"po-md-6","po-lg-2",3,"ngModelChange","ngModel"],["name","singleSelect","p-label","Single Select",1,"po-md-6","po-lg-2",3,"ngModelChange","ngModel"],["name","componentsSize","p-label","Components size","p-help","Para aplicar o tamanho small, configure o n\xEDvel de acessibilidade para AA, ajust\xE1vel no navbar ou servi\xE7o de tema (https://po-ui.io/documentation/po-theme).",1,"po-lg-5",3,"ngModelChange","ngModel","p-options"],["p-label","Po Tree View Item"],["name","parent","p-label","Parent Item","p-placeholder","Add tree view item",1,"po-md-6","po-lg-4",3,"ngModelChange","ngModel","p-options"],["name","label","p-label","Label","p-required","",1,"po-md-6","po-lg-4",3,"ngModelChange","ngModel"],["name","value","p-label","Value","p-required","",1,"po-md-6","po-lg-4",3,"ngModelChange","ngModel"],["name","itemProperties","p-columns","3","p-label","Item Properties",1,"po-md-6",3,"ngModelChange","ngModel","p-options"],["p-label","Add",1,"o-md-4","po-lg-2",3,"p-click","p-disabled"],["p-label","Sample Restore",1,"po-md-6","po-lg-3",3,"p-click"]],template:function(o,i){if(o&1){let m=Ix();Sl(0,"po-tree-view",1),ft("p-collapsed",function(p){return i.changeEvent("p-collapsed",p)})("p-expanded",function(p){return i.changeEvent("p-expanded",p)})("p-selected",function(p){return i.changeEvent("p-selected",p)})("p-unselected",function(p){return i.changeEvent("p-unselected",p)}),og(),Wl(1,"po-divider",2),Sl(2,"div",3),Wl(3,"po-info",4),og(),Wl(4,"po-divider",5),Sl(5,"div",3)(6,"po-input",6),Cw("ngModelChange",function(p){return Ky(m),oN(i.maxLevel,p)||(i.maxLevel=p),Xy(p)}),og(),n0(),Sl(7,"po-switch",7),Cw("ngModelChange",function(p){return Ky(m),oN(i.selectable,p)||(i.selectable=p),Xy(p)}),og(),n0(),Sl(8,"po-switch",8),Cw("ngModelChange",function(p){return Ky(m),oN(i.singleSelect,p)||(i.singleSelect=p),Xy(p)}),og(),n0(),Sl(9,"po-radio-group",9),Cw("ngModelChange",function(p){return Ky(m),oN(i.componentsSize,p)||(i.componentsSize=p),Xy(p)}),og(),n0(),og(),Wl(10,"po-divider",10),Sl(11,"form",null,0)(13,"div",3)(14,"po-select",11),Cw("ngModelChange",function(p){return Ky(m),oN(i.parent,p)||(i.parent=p),Xy(p)}),og(),n0(),Sl(15,"po-input",12),Cw("ngModelChange",function(p){return Ky(m),oN(i.treeViewItem.label,p)||(i.treeViewItem.label=p),Xy(p)}),og(),n0(),Sl(16,"po-input",13),Cw("ngModelChange",function(p){return Ky(m),oN(i.treeViewItem.value,p)||(i.treeViewItem.value=p),Xy(p)}),og(),n0(),og(),Sl(17,"div",3)(18,"po-checkbox-group",14),Cw("ngModelChange",function(p){return Ky(m),oN(i.itemProperties,p)||(i.itemProperties=p),Xy(p)}),og(),n0(),og(),Sl(19,"div",3)(20,"po-button",15),ft("p-click",function(){Ky(m);let p=kx(12);return i.add(i.treeViewItem),p.reset(),Xy(i.itemProperties=[])}),og()()(),Wl(21,"po-divider"),Sl(22,"div",3)(23,"po-button",16),ft("p-click",function(){return i.restore()}),og()();}if(o&2){let m=kx(12);rw("p-components-size",i.componentsSize)("p-items",i.items)("p-selectable",i.selectable)("p-max-level",i.maxLevel)("p-single-select",i.singleSelect),Lp(3),rw("p-value",i.event),Lp(3),ww("ngModel",i.maxLevel),i0(),Lp(),ww("ngModel",i.selectable),i0(),Lp(),ww("ngModel",i.singleSelect),i0(),Lp(),ww("ngModel",i.componentsSize),rw("p-options",i.componentsSizeOptions),i0(),Lp(5),ww("ngModel",i.parent),rw("p-options",i.parentList),i0(),Lp(),ww("ngModel",i.treeViewItem.label),i0(),Lp(),ww("ngModel",i.treeViewItem.value),i0(),Lp(2),ww("ngModel",i.itemProperties),rw("p-options",i.itemPropertiesOptions),i0(),Lp(2),rw("p-disabled",m.invalid);}},dependencies:[Q9,Z9,K9,wk,_k,Qt,mv,b3,L3,Tde,Whe,k3,jhe,gNe],encapsulation:2,changeDetection:1})}return a})();var De=a=>({"docs-sample-code-tabs":a}),Se=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(o){return new(o||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-tree-view-labs-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(o,i){o&1&&(Wl(0,"br"),Sl(1,"blockquote",0)(2,"label",1),rN(3,"PO Tree View Labs"),og(),Sl(4,"a",2),ft("click",function(){return i.toggleSampleCodeTabs()}),Wl(5,"span"),rN(6),og()(),Sl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),rN(12,"sample-po-tree-view-labs/sample-po-tree-view-labs.component.html"),og(),Sl(13,"pre",7),rN(14,`<po-tree-view
...
`),og()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),rN(18,"sample-po-tree-view-labs/sample-po-tree-view-labs.component.ts"),og(),Sl(19,"pre",9),rN(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),og()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),rN(18,"sample-po-tree-view-folder-structure/sample-po-tree-view-folder-structure.component.ts"),og(),Sl(19,"pre",9),rN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),og()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),rN(18,"sample-po-tree-view-supermarket/sample-po-tree-view-supermarket.component.ts"),og(),Sl(19,"pre",9),rN(20,`import { Component, ViewChild, ChangeDetectionStrategy } from '@angular/core';
...
`),og()()()()(),Sl(21,"div",10),Wl(22,"sample-po-tree-view-supermarket"),og(),Wl(23,"hr")),o&2&&(Lp(5),Gx("po-icon "+i.sampleCodeButtonIcon),Lp(),dg(" ",i.sampleCodeButtonLabel),Lp(),rw("ngClass",gN(4,Ne,i.hideSampleCodeTabs)));},dependencies:[SO,Ka,Ume,$me,fe],encapsulation:2,changeDetection:1})}return a})();var Ee=(()=>{class a{static \u0275fac=function(o){return new(o||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-tree-view-doc"]],standalone:false,decls:358,vars:0,consts:[[1,"docs-api"],[1,"docs-api-module-import"],[1,"docs-api-class-description"],[1,"docs-api-h3"],[1,"docs-api-class-name"],[1,"doc-code"],[1,"docs-api-directive-selectors"],[1,"docs-api-class-selector-label"],["appCodeHighlight",""],[1,"docs-api-h5","docs-api-method-header"],[1,"docs-api-properties-table"],[1,"docs-api-properties-header-row"],[1,"docs-api-properties-th"],[1,"docs-api-properties-row"],[1,"docs-api-properties-name-cell"],[1,"docs-api-output-marker"],[1,"docs-api-output-alias"],[1,"docs-api-properties-type-cell"],["pan","",1,"docs-api-property-type","EventEmitter"],[1,"docs-api-property-default"],[1,"docs-api-property-description"],[1,"docs-api-input-marker"],[1,"docs-api-input-alias"],["pan","",1,"docs-api-property-type","string"],["href","https://po-ui.io/documentation/po-theme"],["pan","",1,"docs-api-property-type","Array<PoTreeViewItem>"],["pan","",1,"docs-api-property-type","number"],["pan","",1,"docs-api-property-type","boolean"],[1,"docs-api-h4","docs-api-class-name"],["pan","",1,"docs-api-property-type","null"]],template:function(o,i){o&1&&(Sl(0,"div",0)(1,"p",1)(2,"code"),rN(3,"import { PoTreeViewModule } from '@po-ui/ng-components';"),og()(),Sl(4,"div",2)(5,"p"),rN(6,"M\xF3dulo do componente "),Sl(7,"code"),rN(8,"po-tree-view"),og(),rN(9,"."),og()(),Sl(10,"h3",3),rN(11,"Componente"),og(),Sl(12,"h4",4)(13,"code",5),rN(14,"PoTreeViewComponent"),og()(),Sl(15,"div",2)(16,"p"),rN(17,`O componente fornece um modelo de visualiza\xE7\xE3o em \xE1rvore, possibilitando a visualiza\xE7\xE3o das informa\xE7\xF5es de maneira
hier\xE1rquica, desta forma sendo poss\xEDvel utilizar at\xE9 4 n\xEDveis.`),og(),Sl(18,"p"),rN(19,"Nele \xE9 poss\xEDvel navegar entre os itens atrav\xE9s da tecla "),Sl(20,"em"),rN(21,"tab"),og(),rN(22,`, permitindo expandir ou colapsar o item em foco
por meio das teclas `),Sl(23,"em"),rN(24,"enter"),og(),rN(25," e "),Sl(26,"em"),rN(27,"space"),og(),rN(28,"."),og(),Sl(29,"p"),rN(30,"Al\xE9m da navega\xE7\xE3o, o componente possibilita tamb\xE9m a sele\xE7\xE3o dos itens do primeiro ao \xFAltimo n\xEDvel, tanto de forma parcial como completa."),og(),Sl(31,"p"),rN(32,"O componente tamb\xE9m possui eventos disparados ao marcar/desmarcar e expandir/colapsar os itens. "),og()(),Sl(33,"div",6)(34,"h4",7),rN(35,"Seletor"),og(),Sl(36,"pre",8),rN(37,`<po-tree-view
...
`),og()(),Sl(38,"h4",9),rN(39,"Propriedades"),og(),Sl(40,"table",10)(41,"tr",11)(42,"th",12),rN(43,"Nome"),og(),Sl(44,"th",12),rN(45,"Tipo"),og(),Sl(46,"th",12),rN(47,"Padr\xE3o"),og(),Sl(48,"th",12),rN(49,"Descri\xE7\xE3o"),og()(),Sl(50,"tr",13)(51,"td",14)(52,"div",15)(53,"span",16),rN(54," (p-collapsed)"),Wl(55,"br"),og()()(),Sl(56,"td",17)(57,"code",18),rN(58,"EventEmitter"),og()(),Sl(59,"td",19),rN(60,"-"),og(),Sl(61,"td",20)(62,"em")(63,"strong"),rN(64,"(opcional)"),og()(),Sl(65,"p"),rN(66,"A\xE7\xE3o que ser\xE1 disparada ao colapsar um item."),og(),Sl(67,"blockquote")(68,"p"),rN(69,"Como par\xE2metro o componente envia o item colapsado."),og()()()(),Sl(70,"tr",13)(71,"td",14)(72,"div",21)(73,"span",22),rN(74," p-components-size"),Wl(75,"br"),og()()(),Sl(76,"td",17)(77,"code",23),rN(78,"string"),og()(),Sl(79,"td",19)(80,"p")(81,"code"),rN(82,"medium"),og()()(),Sl(83,"td",20)(84,"em")(85,"strong"),rN(86,"(opcional)"),og()(),Sl(87,"p"),rN(88,"Define o tamanho dos componentes de formul\xE1rio:"),og(),Sl(89,"ul")(90,"li")(91,"code"),rN(92,"small"),og(),rN(93,": aplica a medida small de cada componente (dispon\xEDvel apenas para acessibilidade AA)."),og(),Sl(94,"li")(95,"code"),rN(96,"medium"),og(),rN(97,": aplica a medida medium de cada componente."),og()(),Sl(98,"blockquote")(99,"p"),rN(100,"Caso a acessibilidade AA n\xE3o esteja configurada, o tamanho "),Sl(101,"code"),rN(102,"medium"),og(),rN(103,` ser\xE1 mantido.
Para mais detalhes, consulte a documenta\xE7\xE3o do `),Sl(104,"a",24),rN(105,"po-theme"),og(),rN(106,"."),og()()()(),Sl(107,"tr",13)(108,"td",14)(109,"div",15)(110,"span",16),rN(111," (p-expanded)"),Wl(112,"br"),og()()(),Sl(113,"td",17)(114,"code",18),rN(115,"EventEmitter"),og()(),Sl(116,"td",19),rN(117,"-"),og(),Sl(118,"td",20)(119,"em")(120,"strong"),rN(121,"(opcional)"),og()(),Sl(122,"p"),rN(123,"A\xE7\xE3o que ser\xE1 disparada ao expandir um item."),og(),Sl(124,"blockquote")(125,"p"),rN(126,"Como par\xE2metro o componente envia o item expandido."),og()()()(),Sl(127,"tr",13)(128,"td",14)(129,"div",21)(130,"span",22),rN(131," p-items"),Wl(132,"br"),og()()(),Sl(133,"td",17)(134,"code",25),rN(135,"Array<PoTreeViewItem>"),og()(),Sl(136,"td",19),rN(137,"-"),og(),Sl(138,"td",20)(139,"p"),rN(140,"Lista de itens do tipo "),Sl(141,"code"),rN(142,"PoTreeViewItem"),og(),rN(143," que ser\xE1 renderizada pelo componente."),og()()(),Sl(144,"tr",13)(145,"td",14)(146,"div",21)(147,"span",22),rN(148," p-max-level"),Wl(149,"br"),og()()(),Sl(150,"td",17)(151,"code",26),rN(152,"number"),og()(),Sl(153,"td",19)(154,"p"),rN(155,"4"),og()(),Sl(156,"td",20)(157,"em")(158,"strong"),rN(159,"(opcional)"),og()(),Sl(160,"p"),rN(161,"Define o m\xE1ximo de n\xEDveis para o tree-view."),og(),Sl(162,"blockquote")(163,"p"),rN(164,"O valor padr\xE3o \xE9 4"),og()()()(),Sl(165,"tr",13)(166,"td",14)(167,"div",21)(168,"span",22),rN(169," p-selectable"),Wl(170,"br"),og()()(),Sl(171,"td",17)(172,"code",27),rN(173,"boolean"),og()(),Sl(174,"td",19)(175,"p"),rN(176,"false"),og()(),Sl(177,"td",20)(178,"em")(179,"strong"),rN(180,"(opcional)"),og()(),Sl(181,"p"),rN(182,"Habilita uma caixa de sele\xE7\xE3o para selecionar e/ou desmarcar um item da lista."),og()()(),Sl(183,"tr",13)(184,"td",14)(185,"div",15)(186,"span",16),rN(187," (p-selected)"),Wl(188,"br"),og()()(),Sl(189,"td",17)(190,"code",18),rN(191,"EventEmitter"),og()(),Sl(192,"td",19),rN(193,"-"),og(),Sl(194,"td",20)(195,"em")(196,"strong"),rN(197,"(opcional)"),og()(),Sl(198,"p"),rN(199,"A\xE7\xE3o que ser\xE1 disparada ao selecionar um item."),og(),Sl(200,"blockquote")(201,"p"),rN(202,"Como par\xE2metro o componente envia o item selecionado."),og()()()(),Sl(203,"tr",13)(204,"td",14)(205,"div",21)(206,"span",22),rN(207," p-single-select"),Wl(208,"br"),og()()(),Sl(209,"td",17)(210,"code",27),rN(211,"boolean"),og()(),Sl(212,"td",19)(213,"p"),rN(214,"false"),og()(),Sl(215,"td",20)(216,"em")(217,"strong"),rN(218,"(opcional)"),og()(),Sl(219,"p"),rN(220,"Habilita a sele\xE7\xE3o para item \xFAnico atr\xE1ves de po-radio."),og()()(),Sl(221,"tr",13)(222,"td",14)(223,"div",15)(224,"span",16),rN(225," (p-unselected)"),Wl(226,"br"),og()()(),Sl(227,"td",17)(228,"code",18),rN(229,"EventEmitter"),og()(),Sl(230,"td",19),rN(231,"-"),og(),Sl(232,"td",20)(233,"em")(234,"strong"),rN(235,"(opcional)"),og()(),Sl(236,"p"),rN(237,"A\xE7\xE3o que ser\xE1 disparada ao desfazer a sele\xE7\xE3o de um item."),og(),Sl(238,"blockquote")(239,"p"),rN(240,"Como par\xE2metro o componente envia o item que foi desmarcado."),og()()()()(),Sl(241,"h3"),rN(242,"Interfaces"),og(),Sl(243,"h4",28)(244,"code",5),rN(245,"PoTreeViewItem"),og()(),Sl(246,"div",2)(247,"p"),rN(248,"Interface para defini\xE7\xE3o dos itens do componente "),Sl(249,"code"),rN(250,"po-tree-view"),og(),rN(251,"."),og()(),Sl(252,"h4",9),rN(253,"Propriedades"),og(),Sl(254,"table",10)(255,"tr",11)(256,"th",12),rN(257,"Nome"),og(),Sl(258,"th",12),rN(259,"Tipo"),og(),Sl(260,"th",12),rN(261,"Descri\xE7\xE3o"),og()(),Sl(262,"tr",13)(263,"td",14)(264,"div",21)(265,"span",22),rN(266," expanded"),Wl(267,"br"),og()()(),Sl(268,"td",17)(269,"code",27),rN(270,"boolean"),og()(),Sl(271,"td",20)(272,"em")(273,"strong"),rN(274,"(opcional)"),og()(),Sl(275,"p"),rN(276,"Expande o item."),og()()(),Sl(277,"tr",13)(278,"td",14)(279,"div",21)(280,"span",22),rN(281," isSelectable"),Wl(282,"br"),og()()(),Sl(283,"td",17)(284,"code",27),rN(285,"boolean "),og(),Sl(286,"code",29),rN(287," null"),og()(),Sl(288,"td",20)(289,"em")(290,"strong"),rN(291,"(opcional)"),og()(),Sl(292,"p"),rN(293,"Permite ativar/desativar a sele\xE7\xE3o do item"),og()()(),Sl(294,"tr",13)(295,"td",14)(296,"div",21)(297,"span",22),rN(298," label"),Wl(299,"br"),og()()(),Sl(300,"td",17)(301,"code",23),rN(302,"string"),og()(),Sl(303,"td",20)(304,"p"),rN(305,`Desabilita a selec\xE3o do item.
Texto de exibi\xE7\xE3o do item.`),og()()(),Sl(306,"tr",13)(307,"td",14)(308,"div",21)(309,"span",22),rN(310," selected"),Wl(311,"br"),og()()(),Sl(312,"td",17)(313,"code",27),rN(314,"boolean "),og(),Sl(315,"code",29),rN(316," null"),og()(),Sl(317,"td",20)(318,"em")(319,"strong"),rN(320,"(opcional)"),og()(),Sl(321,"p"),rN(322,"Marca o item como selecionado."),og(),Sl(323,"blockquote")(324,"p"),rN(325,"Caso o item que conter "),Sl(326,"code"),rN(327,"subItems"),og(),rN(328," for selecionado, os seus itens filhos ser\xE3o tamb\xE9m selecionados."),og()()()(),Sl(329,"tr",13)(330,"td",14)(331,"div",21)(332,"span",22),rN(333," subItems"),Wl(334,"br"),og()()(),Sl(335,"td",17)(336,"code",25),rN(337,"Array<PoTreeViewItem>"),og()(),Sl(338,"td",20)(339,"em")(340,"strong"),rN(341,"(opcional)"),og()(),Sl(342,"p"),rN(343,"Lista de itens do pr\xF3ximo n\xEDvel, e assim consecutivamente at\xE9 que se atinja o quarto n\xEDvel."),og()()(),Sl(344,"tr",13)(345,"td",14)(346,"div",21)(347,"span",22),rN(348," value"),Wl(349,"br"),og()()(),Sl(350,"td",17)(351,"code",23),rN(352,"string "),og(),Sl(353,"code",26),rN(354," number"),og()(),Sl(355,"td",20)(356,"p"),rN(357,"Valor do item que poder\xE1 ser utilizado como refer\xEAncia para sua identifica\xE7\xE3o."),og()()()()());},dependencies:[Ka],encapsulation:2,changeDetection:1})}return a})();var Te=(()=>{class a{route;router;sub;hidePoWebSample=true;samplesLength=4;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(r,o){this.route=r,this.router=o;}goBack(){this.router.navigate(["documentation"]);}improveDocs(){this.router.navigate(["guides/development-flow"]);}ngOnInit(){this.sub=this.route.queryParams.subscribe(r=>{let o=r.view;this.activeTab=o||"doc",this.hidePoWebSample=this.samplesLength===0;});}changeTab(r){this.router.navigate([],{queryParams:{view:r},queryParamsHandling:"merge"}),this.activeTab=r;}ngOnDestroy(){this.sub.unsubscribe();}static \u0275fac=function(o){return new(o||a)(w(Xn),w(En))};static \u0275cmp=Un({type:a,selectors:[["ng-component"]],standalone:false,decls:9,vars:4,consts:[["p-title","Tree View",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(o,i){o&1&&(Sl(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),ft("p-click",function(){return i.changeTab("doc")}),Wl(3,"sample-po-tree-view-doc"),og(),Sl(4,"po-tab",3),ft("p-click",function(){return i.changeTab("web")}),Wl(5,"sample-po-tree-view-basic-view")(6,"sample-po-tree-view-labs-view")(7,"sample-po-tree-view-folder-structure-view")(8,"sample-po-tree-view-supermarket-view"),og()()()),o&2&&(rw("p-actions",i.actions),Lp(2),rw("p-active",i.activeTab==="doc"),Lp(2),rw("p-hide",i.hidePoWebSample)("p-active",i.activeTab==="web"));},dependencies:[sNe,Ume,$me,ve,Se,we,Ce,Ee],encapsulation:2,changeDetection:1})}return a})();var We=[{path:"",component:Te}],Pe=(()=>{class a{static \u0275fac=function(o){return new(o||a)};static \u0275mod=fe$1({type:a});static \u0275inj=ue$1({imports:[mL.forChild(We),mL]})}return a})();var gt=(()=>{class a{static \u0275fac=function(o){return new(o||a)};static \u0275mod=fe$1({type:a});static \u0275inj=ue$1({imports:[sr,Pe]})}return a})();export{gt as DocPoTreeViewModule};