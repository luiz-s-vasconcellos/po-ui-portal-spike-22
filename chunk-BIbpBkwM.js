import {f as fe,u as ue$1,s as sr,D as DL,w,c3 as Xn,a as wn,U as Un,c as f,aW as Yp,cX as I3,L as Gl,an as AO,aH as Ka,b8 as Ume,b9 as $me,T as Tl,C as iN,M as sg,a1 as ht,H as Vp,ar as qx,au as fg,O as nw,bs as mN,aX as oY,aF as nY,aY as rY,aG as Sk,aZ as Ck,b0 as Qt,b1 as mv,c4 as b3,b4 as L3,cp as Bhe,c8 as Tde,c9 as jhe,aB as Sx,aM as ww,aN as r0,aO as Ew,aP as o0,b7 as M3,bd as Fx,av as Yl,aw as uo,ax as fo,a3 as sNe,aD as Ky,aT as sN,aE as Xy,o as K}from'./main-JFQ6NFFH.js';var me=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic"]],standalone:false,decls:1,vars:0,consts:[["name","url","p-label","PO Url"]],template:function(l,i){l&1&&Gl(0,"po-url",0);},dependencies:[I3],encapsulation:2,changeDetection:1})}return a})();var ge=a=>({"docs-sample-code-tabs":a}),pe=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),iN(3,"PO Url Basic"),sg(),Tl(4,"a",2),ht("click",function(){return i.toggleSampleCodeTabs()}),Gl(5,"span"),iN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),iN(12,"sample-po-url-basic/sample-po-url-basic.component.html"),sg(),Tl(13,"pre",7),iN(14,`<po-url name="url" p-label="PO Url"> </po-url>
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),iN(18,"sample-po-url-basic/sample-po-url-basic.component.ts"),sg(),Tl(19,"pre",9),iN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),iN(18,"sample-po-url-labs/sample-po-url-labs.component.ts"),sg(),Tl(19,"pre",9),iN(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()()()(),Tl(21,"div",10),Gl(22,"sample-po-url-labs"),sg(),Gl(23,"hr")),l&2&&(Vp(5),qx("po-icon "+i.sampleCodeButtonIcon),Vp(),fg(" ",i.sampleCodeButtonLabel),Vp(),nw("ngClass",mN(4,ye,i.hideSampleCodeTabs)));},dependencies:[AO,Ka,Ume,$me,se],encapsulation:2,changeDetection:1})}return a})();var Pe=["boxUrl"],ue=(()=>{class a{poNotification=f(Yp);boxUrlElement;baseUrls=[];shortenedUrl;url;urlColumns=[{property:"url",label:"Long URL"},{property:"short",label:"Shortened URL"}];copyToClipboard(){this.boxUrlElement.nativeElement.querySelector("input").select(),document.execCommand("copy"),this.poNotification.success("Text copied!");}shortenUrl(){let d=btoa(this.url.replace(/http|www|com|br|\/|\./gi,"").trim());this.shortenedUrl=`po.com/${d.substr(d.length-3)}`+this.baseUrls.length,this.baseUrls.push({url:this.url,short:this.shortenedUrl});}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener"]],viewQuery:function(l,i){if(l&1&&Yl(Pe,7,K),l&2){let p;uo(p=fo())&&(i.boxUrlElement=p.first);}},standalone:false,decls:11,vars:7,consts:[["f","ngForm"],["boxUrl",""],[1,"po-row"],["name","url","p-label","Type your URL to be shortened","p-required","",1,"po-lg-6",3,"ngModelChange","ngModel"],["name","shortenedUrl","p-label","URL shortened","p-readonly","",1,"po-lg-6",3,"ngModelChange","ngModel"],["p-label","Shorten URL","p-kind","primary",1,"po-lg-2",3,"p-click","p-disabled"],["p-icon","an an-copy","p-label","Copy",1,"po-offset-lg-4","po-offset-xl-4","po-lg-2",3,"click","p-disabled"],["p-striped","true",3,"p-columns","p-items","p-hide-table-search"]],template:function(l,i){if(l&1){let p=Sx();Tl(0,"form",null,0)(2,"div",2)(3,"po-url",3),ww("ngModelChange",function(r){return Ky(p),sN(i.url,r)||(i.url=r),Xy(r)}),sg(),r0(),Tl(4,"po-input",4,1),ww("ngModelChange",function(r){return Ky(p),sN(i.shortenedUrl,r)||(i.shortenedUrl=r),Xy(r)}),sg(),r0(),sg(),Tl(6,"div",2)(7,"po-button",5),ht("p-click",function(){return i.shortenUrl()}),sg(),Tl(8,"po-button",6),ht("click",function(){return i.copyToClipboard()}),sg()()(),Gl(9,"po-divider")(10,"po-table",7);}if(l&2){let p=Fx(1);Vp(3),Ew("ngModel",i.url),o0(),Vp(),Ew("ngModel",i.shortenedUrl),o0(),Vp(3),nw("p-disabled",p.invalid),Vp(),nw("p-disabled",!i.shortenedUrl),Vp(2),nw("p-columns",i.urlColumns)("p-items",i.baseUrls)("p-hide-table-search",false);}},dependencies:[oY,nY,rY,Sk,Ck,Qt,mv,L3,I3,M3],encapsulation:2,changeDetection:1})}return a})();var Me=a=>({"docs-sample-code-tabs":a}),Ee=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),iN(3,"PO Url - Shortener"),sg(),Tl(4,"a",2),ht("click",function(){return i.toggleSampleCodeTabs()}),Gl(5,"span"),iN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),iN(12,"sample-po-url-shortener/sample-po-url-shortener.component.html"),sg(),Tl(13,"pre",7),iN(14,`<form #f="ngForm">
  <div class="po-row">
...
`),sg()()(),Tl(15,"po-tab",8)(16,"div")(17,"label",6),iN(18,"sample-po-url-shortener/sample-po-url-shortener.component.ts"),sg(),Tl(19,"pre",9),iN(20,`import { Component, ElementRef, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
