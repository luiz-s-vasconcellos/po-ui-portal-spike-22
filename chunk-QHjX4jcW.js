import {f as fe,u as ue$1,a as ar,p as pL,C,c3 as Xn,b as wn,U as Un,d as f,aW as Yp,cX as O3,M as Wl,an as bO,aH as Ga,b8 as Gme,b9 as Qme,H as Sl,J as Jx,O as sg,a1 as ht,z as Vp,ar as Hx,au as fg,T as tw,bs as dN,aX as J9,aF as K9,aY as X9,aG as Dk,aZ as vk,b0 as Qt,b1 as mv,c4 as x3,b4 as F3,cp as Uhe,c8 as Pde,c9 as Qhe,aB as Ex,aM as Ew,aN as JA,aO as Dw,aP as t0,b7 as A3,bd as xx,av as ql,aw as lo,ax as uo,a3 as pNe,aD as Xy,aT as tN,aE as Qy,Z}from'./main-BY5NURRA.js';var me=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic"]],standalone:false,decls:1,vars:0,consts:[["name","url","p-label","PO Url"]],template:function(l,i){l&1&&Wl(0,"po-url",0);},dependencies:[O3],encapsulation:2,changeDetection:1})}return a})();var ge=a=>({"docs-sample-code-tabs":a}),pe=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Wl(0,"br"),Sl(1,"blockquote",0)(2,"label",1),Jx(3,"PO Url Basic"),sg(),Sl(4,"a",2),ht("click",function(){return i.toggleSampleCodeTabs()}),Wl(5,"span"),Jx(6),sg()(),Sl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),Jx(12,"sample-po-url-basic/sample-po-url-basic.component.html"),sg(),Sl(13,"pre",7),Jx(14,`<po-url name="url" p-label="PO Url"> </po-url>
`),sg()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),Jx(18,"sample-po-url-basic/sample-po-url-basic.component.ts"),sg(),Sl(19,"pre",9),Jx(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),Jx(18,"sample-po-url-labs/sample-po-url-labs.component.ts"),sg(),Sl(19,"pre",9),Jx(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),sg()()()()(),Sl(21,"div",10),Wl(22,"sample-po-url-labs"),sg(),Wl(23,"hr")),l&2&&(Vp(5),Hx("po-icon "+i.sampleCodeButtonIcon),Vp(),fg(" ",i.sampleCodeButtonLabel),Vp(),tw("ngClass",dN(4,ye,i.hideSampleCodeTabs)));},dependencies:[bO,Ga,Gme,Qme,se],encapsulation:2})}return a})();var Pe=["boxUrl"],ue=(()=>{class a{poNotification=f(Yp);boxUrlElement;baseUrls=[];shortenedUrl;url;urlColumns=[{property:"url",label:"Long URL"},{property:"short",label:"Shortened URL"}];copyToClipboard(){this.boxUrlElement.nativeElement.querySelector("input").select(),document.execCommand("copy"),this.poNotification.success("Text copied!");}shortenUrl(){let d=btoa(this.url.replace(/http|www|com|br|\/|\./gi,"").trim());this.shortenedUrl=`po.com/${d.substr(d.length-3)}`+this.baseUrls.length,this.baseUrls.push({url:this.url,short:this.shortenedUrl});}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener"]],viewQuery:function(l,i){if(l&1&&ql(Pe,7,Z),l&2){let p;lo(p=uo())&&(i.boxUrlElement=p.first);}},standalone:false,decls:11,vars:7,consts:[["f","ngForm"],["boxUrl",""],[1,"po-row"],["name","url","p-label","Type your URL to be shortened","p-required","",1,"po-lg-6",3,"ngModelChange","ngModel"],["name","shortenedUrl","p-label","URL shortened","p-readonly","",1,"po-lg-6",3,"ngModelChange","ngModel"],["p-label","Shorten URL","p-kind","primary",1,"po-lg-2",3,"p-click","p-disabled"],["p-icon","an an-copy","p-label","Copy",1,"po-offset-lg-4","po-offset-xl-4","po-lg-2",3,"click","p-disabled"],["p-striped","true",3,"p-columns","p-items","p-hide-table-search"]],template:function(l,i){if(l&1){let p=Ex();Sl(0,"form",null,0)(2,"div",2)(3,"po-url",3),Ew("ngModelChange",function(r){return Xy(p),tN(i.url,r)||(i.url=r),Qy(r)}),sg(),JA(),Sl(4,"po-input",4,1),Ew("ngModelChange",function(r){return Xy(p),tN(i.shortenedUrl,r)||(i.shortenedUrl=r),Qy(r)}),sg(),JA(),sg(),Sl(6,"div",2)(7,"po-button",5),ht("p-click",function(){return i.shortenUrl()}),sg(),Sl(8,"po-button",6),ht("click",function(){return i.copyToClipboard()}),sg()()(),Wl(9,"po-divider")(10,"po-table",7);}if(l&2){let p=xx(1);Vp(3),Dw("ngModel",i.url),t0(),Vp(),Dw("ngModel",i.shortenedUrl),t0(),Vp(3),tw("p-disabled",p.invalid),Vp(),tw("p-disabled",!i.shortenedUrl),Vp(2),tw("p-columns",i.urlColumns)("p-items",i.baseUrls)("p-hide-table-search",false);}},dependencies:[J9,K9,X9,Dk,vk,Qt,mv,F3,O3,A3],encapsulation:2,changeDetection:1})}return a})();var Me=a=>({"docs-sample-code-tabs":a}),Ee=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Wl(0,"br"),Sl(1,"blockquote",0)(2,"label",1),Jx(3,"PO Url - Shortener"),sg(),Sl(4,"a",2),ht("click",function(){return i.toggleSampleCodeTabs()}),Wl(5,"span"),Jx(6),sg()(),Sl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),Jx(12,"sample-po-url-shortener/sample-po-url-shortener.component.html"),sg(),Sl(13,"pre",7),Jx(14,`<form #f="ngForm">
  <div class="po-row">
...
`),sg()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),Jx(18,"sample-po-url-shortener/sample-po-url-shortener.component.ts"),sg(),Sl(19,"pre",9),Jx(20,`import { Component, ElementRef, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
...
Executada ao disparar o output `),Sl(1309,"code"),Jx(1310,"change"),sg(),Jx(1311," ou "),Sl(1312,"code"),Jx(1313,"change-model"),sg(),Jx(1314,", dependendo do valor da propriedade "),Sl(1315,"code"),Jx(1316,"triggerMode"),sg(),Jx(1317,"."),sg()()(),Sl(1318,"tr",15)(1319,"td",16)(1320,"div",24)(1321,"span",25),Jx(1322," triggerMode"),Wl(1323,"br"),sg()()(),Sl(1324,"td",20)(1325,"code",39),Jx(1326,"'change' "),sg(),Sl(1327,"code",40),Jx(1328," 'changeModel'"),sg()(),Sl(1329,"td",23)(1330,"em")(1331,"strong"),Jx(1332,"(opcional)"),sg()(),Sl(1333,"p"),Jx(1334,"Controla se o m\xE9todo ser\xE1 executado no disparo do output "),Sl(1335,"code"),Jx(1336,"change"),sg(),Jx(1337," ou "),Sl(1338,"code"),Jx(1339,"change-model"),sg(),Jx(1340,"."),sg()()()()());},dependencies:[Ga],encapsulation:2})}return a})();var be=(()=>{class a{route;router;sub;hidePoWebSample=true;samplesLength=3;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(d,l){this.route=d,this.router=l;}goBack(){this.router.navigate(["documentation"]);}improveDocs(){this.router.navigate(["guides/development-flow"]);}ngOnInit(){this.sub=this.route.queryParams.subscribe(d=>{let l=d.view;this.activeTab=l||"doc",this.hidePoWebSample=this.samplesLength===0;});}changeTab(d){this.router.navigate([],{queryParams:{view:d},queryParamsHandling:"merge"}),this.activeTab=d;}ngOnDestroy(){this.sub.unsubscribe();}static \u0275fac=function(l){return new(l||a)(C(Xn),C(wn))};static \u0275cmp=Un({type:a,selectors:[["ng-component"]],standalone:false,decls:8,vars:4,consts:[["p-title","Url",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(l,i){l&1&&(Sl(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),ht("p-click",function(){return i.changeTab("doc")}),Wl(3,"sample-po-url-doc"),sg(),Sl(4,"po-tab",3),ht("p-click",function(){return i.changeTab("web")}),Wl(5,"sample-po-url-basic-view")(6,"sample-po-url-labs-view")(7,"sample-po-url-shortener-view"),sg()()()),l&2&&(tw("p-actions",i.actions),Vp(2),tw("p-active",i.activeTab==="doc"),Vp(2),tw("p-hide",i.hidePoWebSample)("p-active",i.activeTab==="web"));},dependencies:[pNe,Gme,Qme,pe,ce,Ee,Se],encapsulation:2})}return a})();var De=[{path:"",component:be}],he=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=fe({type:a});static \u0275inj=ue$1({imports:[pL.forChild(De),pL]})}return a})();var at=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=fe({type:a});static \u0275inj=ue$1({imports:[ar,he]})}return a})();export{at as DocPoUrlModule};