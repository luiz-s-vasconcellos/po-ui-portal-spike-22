import {f as fe,u as ue$1,s as sr,m as mL,w,c3 as Xn,E as En,U as Un,c as f,aW as Yp,cX as I3,F as Wl,an as SO,aH as Ka,b8 as Ume,b9 as $me,C as Sl,y as rN,J as og,a1 as ft,L as Lp,ar as Gx,au as dg,O as rw,bs as gN,aX as Q9,aF as Z9,aY as K9,aG as wk,aZ as _k,b0 as Qt,b1 as mv,c4 as b3,b4 as L3,cp as Bhe,c8 as Tde,c9 as jhe,aB as Ix,aM as Cw,aN as n0,aO as ww,aP as i0,b7 as M3,bd as kx,av as ql,aw as lo,ax as uo,a3 as sNe,aD as Ky,aT as oN,aE as Xy,K}from'./main-LEW6T6YX.js';var me=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic"]],standalone:false,decls:1,vars:0,consts:[["name","url","p-label","PO Url"]],template:function(l,i){l&1&&Wl(0,"po-url",0);},dependencies:[I3],encapsulation:2,changeDetection:1})}return a})();var ge=a=>({"docs-sample-code-tabs":a}),pe=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Wl(0,"br"),Sl(1,"blockquote",0)(2,"label",1),rN(3,"PO Url Basic"),og(),Sl(4,"a",2),ft("click",function(){return i.toggleSampleCodeTabs()}),Wl(5,"span"),rN(6),og()(),Sl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),rN(12,"sample-po-url-basic/sample-po-url-basic.component.html"),og(),Sl(13,"pre",7),rN(14,`<po-url name="url" p-label="PO Url"> </po-url>
`),og()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),rN(18,"sample-po-url-basic/sample-po-url-basic.component.ts"),og(),Sl(19,"pre",9),rN(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),og()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),rN(18,"sample-po-url-labs/sample-po-url-labs.component.ts"),og(),Sl(19,"pre",9),rN(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),og()()()()(),Sl(21,"div",10),Wl(22,"sample-po-url-labs"),og(),Wl(23,"hr")),l&2&&(Lp(5),Gx("po-icon "+i.sampleCodeButtonIcon),Lp(),dg(" ",i.sampleCodeButtonLabel),Lp(),rw("ngClass",gN(4,ye,i.hideSampleCodeTabs)));},dependencies:[SO,Ka,Ume,$me,se],encapsulation:2,changeDetection:1})}return a})();var Pe=["boxUrl"],ue=(()=>{class a{poNotification=f(Yp);boxUrlElement;baseUrls=[];shortenedUrl;url;urlColumns=[{property:"url",label:"Long URL"},{property:"short",label:"Shortened URL"}];copyToClipboard(){this.boxUrlElement.nativeElement.querySelector("input").select(),document.execCommand("copy"),this.poNotification.success("Text copied!");}shortenUrl(){let d=btoa(this.url.replace(/http|www|com|br|\/|\./gi,"").trim());this.shortenedUrl=`po.com/${d.substr(d.length-3)}`+this.baseUrls.length,this.baseUrls.push({url:this.url,short:this.shortenedUrl});}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener"]],viewQuery:function(l,i){if(l&1&&ql(Pe,7,K),l&2){let p;lo(p=uo())&&(i.boxUrlElement=p.first);}},standalone:false,decls:11,vars:7,consts:[["f","ngForm"],["boxUrl",""],[1,"po-row"],["name","url","p-label","Type your URL to be shortened","p-required","",1,"po-lg-6",3,"ngModelChange","ngModel"],["name","shortenedUrl","p-label","URL shortened","p-readonly","",1,"po-lg-6",3,"ngModelChange","ngModel"],["p-label","Shorten URL","p-kind","primary",1,"po-lg-2",3,"p-click","p-disabled"],["p-icon","an an-copy","p-label","Copy",1,"po-offset-lg-4","po-offset-xl-4","po-lg-2",3,"click","p-disabled"],["p-striped","true",3,"p-columns","p-items","p-hide-table-search"]],template:function(l,i){if(l&1){let p=Ix();Sl(0,"form",null,0)(2,"div",2)(3,"po-url",3),Cw("ngModelChange",function(r){return Ky(p),oN(i.url,r)||(i.url=r),Xy(r)}),og(),n0(),Sl(4,"po-input",4,1),Cw("ngModelChange",function(r){return Ky(p),oN(i.shortenedUrl,r)||(i.shortenedUrl=r),Xy(r)}),og(),n0(),og(),Sl(6,"div",2)(7,"po-button",5),ft("p-click",function(){return i.shortenUrl()}),og(),Sl(8,"po-button",6),ft("click",function(){return i.copyToClipboard()}),og()()(),Wl(9,"po-divider")(10,"po-table",7);}if(l&2){let p=kx(1);Lp(3),ww("ngModel",i.url),i0(),Lp(),ww("ngModel",i.shortenedUrl),i0(),Lp(3),rw("p-disabled",p.invalid),Lp(),rw("p-disabled",!i.shortenedUrl),Lp(2),rw("p-columns",i.urlColumns)("p-items",i.baseUrls)("p-hide-table-search",false);}},dependencies:[Q9,Z9,K9,wk,_k,Qt,mv,L3,I3,M3],encapsulation:2,changeDetection:1})}return a})();var Me=a=>({"docs-sample-code-tabs":a}),Ee=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Wl(0,"br"),Sl(1,"blockquote",0)(2,"label",1),rN(3,"PO Url - Shortener"),og(),Sl(4,"a",2),ft("click",function(){return i.toggleSampleCodeTabs()}),Wl(5,"span"),rN(6),og()(),Sl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),rN(12,"sample-po-url-shortener/sample-po-url-shortener.component.html"),og(),Sl(13,"pre",7),rN(14,`<form #f="ngForm">
  <div class="po-row">
...
`),og()()(),Sl(15,"po-tab",8)(16,"div")(17,"label",6),rN(18,"sample-po-url-shortener/sample-po-url-shortener.component.ts"),og(),Sl(19,"pre",9),rN(20,`import { Component, ElementRef, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
...
leitura clara.`),og()()(),Sl(756,"tr",15)(757,"td",16)(758,"div",24)(759,"span",25),rN(760," p-loading"),Wl(761,"br"),og()()(),Sl(762,"td",20)(763,"code",27),rN(764,"boolean"),og()(),Sl(765,"td",22)(766,"p")(767,"code"),rN(768,"false"),og()()(),Sl(769,"td",23)(770,"em")(771,"strong"),rN(772,"(opcional)"),og()(),Sl(773,"p"),rN(774,"Exibe um \xEDcone de carregamento no lado direito do campo para sinalizar que uma opera\xE7\xE3o est\xE1 em andamento."),og()()(),Sl(775,"tr",15)(776,"td",16)(777,"div",24)(778,"span",25),rN(779,"p-mask"),Wl(780,"br"),og()()(),Sl(781,"td",20)(782,"code",26),rN(783,"string"),og()(),Sl(784,"td",22),rN(785,"-"),og(),Sl(786,"td",23)(787,"em")(788,"strong"),rN(789,"(opcional)"),og()(),Sl(790,"p"),rN(791,`Indica uma m\xE1scara para o campo. Exemplos: (+99) (99) 99999?-9999, 99999-999, 999.999.999-99.
A m\xE1scara gera uma valida\xE7\xE3o autom\xE1tica do campo, podendo esta ser substitu\xEDda por um REGEX espec\xEDfico
atrav\xE9s da propriedade p-pattern.
O campo ser\xE1 sinalizado e o formul\xE1rio ficar\xE1 inv\xE1lido quando o valor informado estiver fora do padr\xE3o definido,
mesmo quando desabilitado.`),og()()(),Sl(792,"tr",15)(793,"td",16)(794,"div",24)(795,"span",25),rN(796,"p-mask-format-model"),Wl(797,"br"),og()()(),Sl(798,"td",20)(799,"code",27),rN(800,"boolean"),og()(),Sl(801,"td",22)(802,"p")(803,"code"),rN(804,"false"),og()()(),Sl(805,"td",23)(806,"em")(807,"strong"),rN(808,"(opcional)"),og()(),Sl(809,"p"),rN(810,"Indica se o "),Sl(811,"code"),rN(812,"model"),og(),rN(813," receber\xE1 o valor formatado pela m\xE1scara ou apenas o valor puro (sem formata\xE7\xE3o)."),og()()(),Sl(814,"tr",15)(815,"td",16)(816,"div",24)(817,"span",25),rN(818," p-mask-no-length-validation"),Wl(819,"br"),og()()(),Sl(820,"td",20)(821,"code",27),rN(822,"boolean"),og()(),Sl(823,"td",22)(824,"p")(825,"code"),rN(826,"false"),og()()(),Sl(827,"td",23)(828,"p"),rN(829,"Controla como o componente aplica as valida\xE7\xF5es de comprimento m\xEDnimo ("),Sl(830,"code"),rN(831,"minLength"),og(),rN(832,") e m\xE1ximo ("),Sl(833,"code"),rN(834,"maxLength"),og(),rN(835,") quando h\xE1 uma m\xE1scara ("),Sl(836,"code"),rN(837,"p-mask"),og(),rN(838,") definida."),og(),Sl(839,"ul")(840,"li"),rN(841,"Quando "),Sl(842,"code"),rN(843,"true"),og(),rN(844,", apenas os caracteres alfanum\xE9ricos ser\xE3o contabilizados para a valida\xE7\xE3o dos comprimentos."),og(),Sl(845,"li"),rN(846,"Quando "),Sl(847,"code"),rN(848,"false"),og(),rN(849,", todos os caracteres, incluindo os especiais da m\xE1scara, ser\xE3o considerados na valida\xE7\xE3o."),og()(),Sl(850,"blockquote")(851,"p"),rN(852,"Esta propriedade \xE9 ignorada quando utilizada em conjunto com "),Sl(853,"code"),rN(854,"p-mask-format-model"),og(),rN(855,"."),og()(),Sl(856,"p"),rN(857,"Exemplo:"),og(),Sl(858,"pre")(859,"code"),rN(860,`<po-input
  p-mask="999-999"
  p-maxlength="6"
  p-minlength="4"
  p-mask-no-length-validation="true"
></po-input>
`),og()(),Sl(861,"ul")(862,"li"),rN(863,"Entrada: "),Sl(864,"code"),rN(865,"123-456"),og(),rN(866," \u2192 Valida\xE7\xE3o ser\xE1 aplicada somente aos n\xFAmeros, ignorando o caractere especial "),Sl(867,"code"),rN(868,"-"),og(),rN(869,"."),og()()()(),Sl(870,"tr",15)(871,"td",16)(872,"div",24)(873,"span",25),rN(874," p-maxlength"),Wl(875,"br"),og()()(),Sl(876,"td",20)(877,"code",31),rN(878,"number"),og()(),Sl(879,"td",22),rN(880,"-"),og(),Sl(881,"td",23)(882,"em")(883,"strong"),rN(884,"(opcional)"),og()(),Sl(885,"p"),rN(886,"Indica a quantidade m\xE1xima de caracteres que o campo aceita."),og()()(),Sl(887,"tr",15)(888,"td",16)(889,"div",24)(890,"span",25),rN(891," p-minlength"),Wl(892,"br"),og()()(),Sl(893,"td",20)(894,"code",31),rN(895,"number"),og()(),Sl(896,"td",22),rN(897,"-"),og(),Sl(898,"td",23)(899,"em")(900,"strong"),rN(901,"(opcional)"),og()(),Sl(902,"p"),rN(903,"Indica a quantidade m\xEDnima de caracteres que o campo aceita."),og()()(),Sl(904,"tr",15)(905,"td",16)(906,"div",24)(907,"span",25),rN(908," name"),Wl(909,"br"),og()()(),Sl(910,"td",20)(911,"code",26),rN(912,"string"),og()(),Sl(913,"td",22),rN(914,"-"),og(),Sl(915,"td",23)(916,"p"),rN(917,"Nome e identificador do campo."),og()()(),Sl(918,"tr",15)(919,"td",16)(920,"div",24)(921,"span",25),rN(922," p-no-autocomplete"),Wl(923,"br"),og()()(),Sl(924,"td",20)(925,"code",27),rN(926,"boolean"),og()(),Sl(927,"td",22)(928,"p")(929,"code"),rN(930,"false"),og()()(),Sl(931,"td",23)(932,"em")(933,"strong"),rN(934,"(opcional)"),og()(),Sl(935,"p"),rN(936,"Define a propriedade nativa "),Sl(937,"code"),rN(938,"autocomplete"),og(),rN(939," do campo como "),Sl(940,"code"),rN(941,"off"),og(),rN(942,"."),og(),Sl(943,"blockquote")(944,"p"),rN(945,"No componente "),Sl(946,"code"),rN(947,"po-password"),og(),rN(948," ser\xE1 definido como "),Sl(949,"code"),rN(950,"new-password"),og(),rN(951,"."),og()(),Sl(952,"p"),rN(953,"Nos componentes "),Sl(954,"code"),rN(955,"po-password"),og(),rN(956," e "),Sl(957,"code"),rN(958,"po-login"),og(),rN(959," o valor padr\xE3o ser\xE1 "),Sl(960,"code"),rN(961,"true"),og(),rN(962,"."),og()()(),Sl(963,"tr",15)(964,"td",16)(965,"div",24)(966,"span",25),rN(967," p-optional"),Wl(968,"br"),og()()(),Sl(969,"td",20)(970,"code",27),rN(971,"boolean"),og()(),Sl(972,"td",22)(973,"p")(974,"code"),rN(975,"false"),og()()(),Sl(976,"td",23)(977,"em")(978,"strong"),rN(979,"(opcional)"),og()(),Sl(980,"p"),rN(981,"Define se a indica\xE7\xE3o de campo opcional ser\xE1 exibida."),og(),Sl(982,"blockquote")(983,"p"),rN(984,"N\xE3o ser\xE1 exibida a indica\xE7\xE3o se:"),og()(),Sl(985,"ul")(986,"li"),rN(987,"O campo conter "),Sl(988,"code"),rN(989,"p-required"),og(),rN(990,";"),og(),Sl(991,"li"),rN(992,"N\xE3o possuir "),Sl(993,"code"),rN(994,"p-help"),og(),rN(995," e/ou "),Sl(996,"code"),rN(997,"p-label"),og(),rN(998,"."),og()()()(),Sl(999,"tr",15)(1e3,"td",16)(1001,"div",24)(1002,"span",25),rN(1003,"p-pattern"),Wl(1004,"br"),og()()(),Sl(1005,"td",20)(1006,"code",26),rN(1007,"string"),og()(),Sl(1008,"td",22),rN(1009,"-"),og(),Sl(1010,"td",23)(1011,"em")(1012,"strong"),rN(1013,"(opcional)"),og()(),Sl(1014,"p"),rN(1015,`Express\xE3o regular para validar o campo.
Quando o campo possuir uma m\xE1scara `),Sl(1016,"code"),rN(1017,"(p-mask)"),og(),rN(1018,` ser\xE1 automaticamente validado por ela, por\xE9m
\xE9 poss\xEDvel definir um p-pattern para substituir a valida\xE7\xE3o da m\xE1scara.`),og()()(),Sl(1019,"tr",15)(1020,"td",16)(1021,"div",24)(1022,"span",25),rN(1023," p-placeholder"),Wl(1024,"br"),og()()(),Sl(1025,"td",20)(1026,"code",26),rN(1027,"string"),og()(),Sl(1028,"td",22)(1029,"p"),rN(1030,"''"),og()(),Sl(1031,"td",23)(1032,"em")(1033,"strong"),rN(1034,"(opcional)"),og()(),Sl(1035,"p"),rN(1036,"Mensagem que aparecer\xE1 enquanto o campo n\xE3o estiver preenchido."),og()()(),Sl(1037,"tr",15)(1038,"td",16)(1039,"div",24)(1040,"span",25),rN(1041," p-helper"),Wl(1042,"br"),og()()(),Sl(1043,"td",20)(1044,"code",32),rN(1045,"PoHelperOptions "),og(),Sl(1046,"code",26),rN(1047," string"),og()(),Sl(1048,"td",22),rN(1049,"-"),og(),Sl(1050,"td",23)(1051,"em")(1052,"strong"),rN(1053,"(opcional)"),og()(),Sl(1054,"p"),rN(1055,"Define as op\xE7\xF5es do componente de ajuda (po-helper) que ser\xE1 exibido ao lado do label quando a propriedade "),Sl(1056,"code"),rN(1057,"p-label"),og(),rN(1058," for definida, ou, ao lado do componente na aus\xEAncia da propriedade "),Sl(1059,"code"),rN(1060,"p-label"),og(),rN(1061,"."),og(),Sl(1062,"blockquote")(1063,"p"),rN(1064,"Para mais informa\xE7\xF5es acesse: "),Sl(1065,"a",33),rN(1066,"https://po-ui.io/documentation/po-helper"),og(),rN(1067,"."),og()(),Sl(1068,"blockquote")(1069,"p"),rN(1070,"Ao configurar esta propriedade, o antigo \xEDcone de ajuda adicional ("),Sl(1071,"code"),rN(1072,"p-additional-help-tooltip"),og(),rN(1073," e "),Sl(1074,"code"),rN(1075,"p-additional-help"),og(),rN(1076,") ser\xE1 ignorado."),og()()()(),Sl(1077,"tr",15)(1078,"td",16)(1079,"div",24)(1080,"span",25),rN(1081,"p-readonly"),Wl(1082,"br"),og()()(),Sl(1083,"td",20)(1084,"code",27),rN(1085,"boolean"),og()(),Sl(1086,"td",22),rN(1087,"-"),og(),Sl(1088,"td",23)(1089,"em")(1090,"strong"),rN(1091,"(opcional)"),og()(),Sl(1092,"p"),rN(1093,"Indica que o campo ser\xE1 somente leitura."),og()()(),Sl(1094,"tr",15)(1095,"td",16)(1096,"div",24)(1097,"span",25),rN(1098,"p-required"),Wl(1099,"br"),og()()(),Sl(1100,"td",20)(1101,"code",27),rN(1102,"boolean"),og()(),Sl(1103,"td",22)(1104,"p")(1105,"code"),rN(1106,"false"),og()()(),Sl(1107,"td",23)(1108,"em")(1109,"strong"),rN(1110,"(opcional)"),og()(),Sl(1111,"p"),rN(1112,"Define que o campo ser\xE1 obrigat\xF3rio."),og(),Sl(1113,"blockquote")(1114,"p"),rN(1115,"Esta propriedade \xE9 desconsiderada quando o input est\xE1 desabilitado "),Sl(1116,"code"),rN(1117,"(p-disabled)"),og(),rN(1118,"."),og()()()(),Sl(1119,"tr",15)(1120,"td",16)(1121,"div",24)(1122,"span",25),rN(1123," p-required-field-error-message"),Wl(1124,"br"),og()()(),Sl(1125,"td",20)(1126,"code",27),rN(1127,"boolean"),og()(),Sl(1128,"td",22)(1129,"p")(1130,"code"),rN(1131,"false"),og()()(),Sl(1132,"td",23)(1133,"em")(1134,"strong"),rN(1135,"(opcional)"),og()(),Sl(1136,"p"),rN(1137,"Exibe a mensagem setada na propriedade "),Sl(1138,"code"),rN(1139,"p-error-pattern"),og(),rN(1140," se o campo estiver vazio e for requerido."),og(),Sl(1141,"blockquote")(1142,"p"),rN(1143,"Necess\xE1rio que a propriedade "),Sl(1144,"code"),rN(1145,"p-required"),og(),rN(1146," esteja habilitada."),og()()()(),Sl(1147,"tr",15)(1148,"td",16)(1149,"div",24)(1150,"span",25),rN(1151," p-show-required"),Wl(1152,"br"),og()()(),Sl(1153,"td",20)(1154,"code",27),rN(1155,"boolean"),og()(),Sl(1156,"td",22),rN(1157,"-"),og(),Sl(1158,"td",23)(1159,"p"),rN(1160,"Define se a indica\xE7\xE3o de campo obrigat\xF3rio ser\xE1 exibida."),og(),Sl(1161,"blockquote")(1162,"p"),rN(1163,"N\xE3o ser\xE1 exibida a indica\xE7\xE3o se:"),og()(),Sl(1164,"ul")(1165,"li"),rN(1166,"N\xE3o possuir "),Sl(1167,"code"),rN(1168,"p-help"),og(),rN(1169," e/ou "),Sl(1170,"code"),rN(1171,"p-label"),og(),rN(1172,"."),og()()()(),Sl(1173,"tr",15)(1174,"td",16)(1175,"div",24)(1176,"span",25),rN(1177," p-size"),Wl(1178,"br"),og()()(),Sl(1179,"td",20)(1180,"code",26),rN(1181,"string"),og()(),Sl(1182,"td",22)(1183,"p")(1184,"code"),rN(1185,"medium"),og()()(),Sl(1186,"td",23)(1187,"em")(1188,"strong"),rN(1189,"(opcional)"),og()(),Sl(1190,"p"),rN(1191,"Define o tamanho do componente:"),og(),Sl(1192,"ul")(1193,"li")(1194,"code"),rN(1195,"small"),og(),rN(1196,": altura do input como 32px (dispon\xEDvel apenas para acessibilidade AA)."),og(),Sl(1197,"li")(1198,"code"),rN(1199,"medium"),og(),rN(1200,": altura do input como 44px."),og()(),Sl(1201,"blockquote")(1202,"p"),rN(1203,"Caso a acessibilidade AA n\xE3o esteja configurada, o tamanho "),Sl(1204,"code"),rN(1205,"medium"),og(),rN(1206,` ser\xE1 mantido.
Para mais detalhes, consulte a documenta\xE7\xE3o do `),Sl(1207,"a",34),rN(1208,"po-theme"),og(),rN(1209,"."),og()()()(),Sl(1210,"tr",15)(1211,"td",16)(1212,"div",24)(1213,"span",25),rN(1214," p-upper-case"),Wl(1215,"br"),og()()(),Sl(1216,"td",20)(1217,"code",27),rN(1218,"boolean"),og()(),Sl(1219,"td",22),rN(1220,"-"),og(),Sl(1221,"td",23)(1222,"p"),rN(1223,"Converte o conte\xFAdo do campo em mai\xFAsulo automaticamente."),og()()()(),Sl(1224,"h3",11),rN(1225,"M\xE9todos"),og(),Sl(1226,"table",35)(1227,"tr",15)(1228,"th",36)(1229,"div",24)(1230,"h4")(1231,"span",25),rN(1232," showAdditionalHelp "),og()()()()(),Sl(1233,"tr",23)(1234,"td",23)(1235,"p"),rN(1236,"M\xE9todo que exibe "),Sl(1237,"code"),rN(1238,"p-helper"),og(),rN(1239," ou executa a a\xE7\xE3o definida em "),Sl(1240,"code"),rN(1241,"p-helper{eventOnClick}"),og(),rN(1242," ou em "),Sl(1243,"code"),rN(1244,"p-additionalHelp"),og(),rN(1245,`.
Para isso, ser\xE1 necess\xE1rio configurar uma tecla de atalho utilizando o evento `),Sl(1246,"code"),rN(1247,"p-keydown"),og(),rN(1248,"."),og(),Sl(1249,"blockquote")(1250,"p"),rN(1251,"Exibe ou oculta o conte\xFAdo do componente "),Sl(1252,"code"),rN(1253,"po-helper"),og(),rN(1254," quando o componente estiver com foco."),og()(),Sl(1255,"pre")(1256,"code"),rN(1257,`// Exemplo com p-label e p-helper
<po-nome-component
 #component
 ...
...
></po-nome-component>
`),og()(),Sl(1258,"pre")(1259,"code"),rN(1260,`...
onKeyDown(event: KeyboardEvent, inp: PoNomeDoComponente): void {
 if (event.code === 'F9') {
   inp.showAdditionalHelp();
 }
}
`),og()()()()(),Wl(1261,"br"),Sl(1262,"table",35)(1263,"tr",15)(1264,"th",36)(1265,"div",24)(1266,"h4")(1267,"span",25),rN(1268," focus "),og()()()()(),Sl(1269,"tr",23)(1270,"td",23)(1271,"p"),rN(1272,"Fun\xE7\xE3o que atribui foco ao componente."),og(),Sl(1273,"p"),rN(1274,"Para utiliz\xE1-la \xE9 necess\xE1rio ter a inst\xE2ncia do componente no DOM, podendo ser utilizado o ViewChild da seguinte forma:"),og(),Sl(1275,"pre")(1276,"code"),rN(1277,`import { PoNomeDoComponenteComponent } from '@po-ui/ng-components';
...
`),og()()()()(),Wl(1278,"br"),Sl(1279,"h3"),rN(1280,"Interfaces"),og(),Sl(1281,"h4",37)(1282,"code",5),rN(1283,"ErrorAsyncProperties"),og()(),Sl(1284,"div",2)(1285,"p"),rN(1286,"Interface para realizar uma valida\xE7\xE3o ass\xEDncrona no componente."),og()(),Sl(1287,"h4",11),rN(1288,"Propriedades"),og(),Sl(1289,"table",12)(1290,"tr",13)(1291,"th",14),rN(1292,"Nome"),og(),Sl(1293,"th",14),rN(1294,"Tipo"),og(),Sl(1295,"th",14),rN(1296,"Descri\xE7\xE3o"),og()(),Sl(1297,"tr",15)(1298,"td",16)(1299,"div",24)(1300,"span",25),rN(1301," errorAsync"),Wl(1302,"br"),og()()(),Sl(1303,"td",20)(1304,"code",38),rN(1305,"(value) => Observable<boolean>"),og()(),Sl(1306,"td",23)(1307,"p"),rN(1308,`Fun\xE7\xE3o obrigat\xF3ria executada para realizar a valida\xE7\xE3o ass\xEDncrona personalizada.
Executada ao disparar o output `),Sl(1309,"code"),rN(1310,"change"),og(),rN(1311," ou "),Sl(1312,"code"),rN(1313,"change-model"),og(),rN(1314,", dependendo do valor da propriedade "),Sl(1315,"code"),rN(1316,"triggerMode"),og(),rN(1317,"."),og()()(),Sl(1318,"tr",15)(1319,"td",16)(1320,"div",24)(1321,"span",25),rN(1322," triggerMode"),Wl(1323,"br"),og()()(),Sl(1324,"td",20)(1325,"code",39),rN(1326,"'change' "),og(),Sl(1327,"code",40),rN(1328," 'changeModel'"),og()(),Sl(1329,"td",23)(1330,"em")(1331,"strong"),rN(1332,"(opcional)"),og()(),Sl(1333,"p"),rN(1334,"Controla se o m\xE9todo ser\xE1 executado no disparo do output "),Sl(1335,"code"),rN(1336,"change"),og(),rN(1337," ou "),Sl(1338,"code"),rN(1339,"change-model"),og(),rN(1340,"."),og()()()()());},dependencies:[Ka],encapsulation:2,changeDetection:1})}return a})();var be=(()=>{class a{route;router;sub;hidePoWebSample=true;samplesLength=3;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(d,l){this.route=d,this.router=l;}goBack(){this.router.navigate(["documentation"]);}improveDocs(){this.router.navigate(["guides/development-flow"]);}ngOnInit(){this.sub=this.route.queryParams.subscribe(d=>{let l=d.view;this.activeTab=l||"doc",this.hidePoWebSample=this.samplesLength===0;});}changeTab(d){this.router.navigate([],{queryParams:{view:d},queryParamsHandling:"merge"}),this.activeTab=d;}ngOnDestroy(){this.sub.unsubscribe();}static \u0275fac=function(l){return new(l||a)(w(Xn),w(En))};static \u0275cmp=Un({type:a,selectors:[["ng-component"]],standalone:false,decls:8,vars:4,consts:[["p-title","Url",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(l,i){l&1&&(Sl(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),ft("p-click",function(){return i.changeTab("doc")}),Wl(3,"sample-po-url-doc"),og(),Sl(4,"po-tab",3),ft("p-click",function(){return i.changeTab("web")}),Wl(5,"sample-po-url-basic-view")(6,"sample-po-url-labs-view")(7,"sample-po-url-shortener-view"),og()()()),l&2&&(rw("p-actions",i.actions),Lp(2),rw("p-active",i.activeTab==="doc"),Lp(2),rw("p-hide",i.hidePoWebSample)("p-active",i.activeTab==="web"));},dependencies:[sNe,Ume,$me,pe,ce,Ee,Se],encapsulation:2,changeDetection:1})}return a})();var Ue=[{path:"",component:be}],he=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=fe({type:a});static \u0275inj=ue$1({imports:[mL.forChild(Ue),mL]})}return a})();var at=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=fe({type:a});static \u0275inj=ue$1({imports:[sr,he]})}return a})();export{at as DocPoUrlModule};