...
`),Vp(),nw("p-disabled",d.form.invalid),Vp(5),Ew("ngModel",o.title),o0(),Vp(),Ew("ngModel",o.icon),nw("p-options",o.iconOptions),o0(),Vp(),Ew("ngModel",o.content),o0(),Vp(),Ew("ngModel",o.primaryActionLabel),o0(),Vp(),Ew("ngModel",o.primaryActionIcon),o0(),Vp(),Ew("ngModel",o.primaryActionProperties),nw("p-options",o.primaryActionOptions),o0(),Vp(),Ew("ngModel",o.secondaryActionLabel),o0(),Vp(),Ew("ngModel",o.secondaryActionIcon),o0(),Vp(),Ew("ngModel",o.secondaryActionProperties),nw("p-options",o.secondaryActionOptions),o0(),Vp(),Ew("ngModel",o.size),nw("p-options",o.sizeOptions),o0(),Vp(),Ew("ngModel",o.properties),nw("p-options",o.propertiesOptions),o0(),Vp(),Ew("ngModel",o.componentsSize),nw("p-options",o.componentsSizeOptions),o0();}},dependencies:[oY,nY,rY,Sk,Ck,Qt,mv,C3,O3,Dde,qhe,Yo],encapsulation:2,changeDetection:1})}return a})();var ve=a=>({"docs-sample-code-tabs":a}),ce=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-modal-labs-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,o){l&1&&(Gl(0,"br"),Tl(1,"blockquote",0)(2,"label",1),iN(3,"PO Modal Labs"),sg(),Tl(4,"a",2),ht("click",function(){return o.toggleSampleCodeTabs()}),Gl(5,"span"),iN(6),sg()(),Tl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),iN(12,"sample-po-modal-labs/sample-po-modal-labs.component.html"),sg(),Tl(13,"pre",7),iN(14,`<po-modal
