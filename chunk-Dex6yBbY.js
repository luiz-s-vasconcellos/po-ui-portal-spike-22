import {f as fe,u as ue$1,a as u5,v as vL,C,bv as Xn,c as Cn,U as Un,d as f,aE as Bp,cr as tr,N as Ul,a$ as fO,ag as fP,aS as Vd,aT as Rd,J as wl,z as Ux,R as ng,a1 as ut,P as Pp,bw as Ax,aY as cg,S as YE,bi as Jx,aF as aY,ae as iY,aG as oY,af as ck,aH as ok,aK as Pe,aL as di,bx as ia,aO as Yo,bT as ha,bB as ga,bC as Vp,al as lx,am as pw,an as $0,ap as hw,aq as G0,aR as ty,aX as _x,as as $l,at as uo,au as fo,a3 as D3,az as Qy,aB as $x,aA as Jy,i as K}from'./main-6SPFG3VI.js';var pe=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic"]],standalone:false,decls:1,vars:0,consts:[["name","url","p-label","PO Url"]],template:function(l,i){l&1&&Ul(0,"po-url",0);},dependencies:[tr],encapsulation:2,changeDetection:1})}return a})();var ve=a=>({"docs-sample-code-tabs":a}),ce=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-basic-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Ul(0,"br"),wl(1,"blockquote",0)(2,"label",1),Ux(3,"PO Url Basic"),ng(),wl(4,"a",2),ut("click",function(){return i.toggleSampleCodeTabs()}),Ul(5,"span"),Ux(6),ng()(),wl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),Ux(12,"sample-po-url-basic/sample-po-url-basic.component.html"),ng(),wl(13,"pre",7),Ux(14,`<po-url name="url" p-label="PO Url"> </po-url>
`),ng()()(),wl(15,"po-tab",8)(16,"div")(17,"label",6),Ux(18,"sample-po-url-basic/sample-po-url-basic.component.ts"),ng(),wl(19,"pre",9),Ux(20,`import { Component, ChangeDetectionStrategy } from '@angular/core';
...
`),ng()()(),wl(15,"po-tab",8)(16,"div")(17,"label",6),Ux(18,"sample-po-url-labs/sample-po-url-labs.component.ts"),ng(),wl(19,"pre",9),Ux(20,`import { Component, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
`),ng()()()()(),wl(21,"div",10),Ul(22,"sample-po-url-labs"),ng(),Ul(23,"hr")),l&2&&(Pp(5),Ax("po-icon "+i.sampleCodeButtonIcon),Pp(),cg(" ",i.sampleCodeButtonLabel),Pp(),YE("ngClass",Jx(4,Te,i.hideSampleCodeTabs)));},dependencies:[fO,fP,Vd,Rd,ue],encapsulation:2})}return a})();var De=["boxUrl"],Se=(()=>{class a{poNotification=f(Bp);boxUrlElement;baseUrls=[];shortenedUrl;url;urlColumns=[{property:"url",label:"Long URL"},{property:"short",label:"Shortened URL"}];copyToClipboard(){this.boxUrlElement.nativeElement.querySelector("input").select(),document.execCommand("copy"),this.poNotification.success("Text copied!");}shortenUrl(){let d=btoa(this.url.replace(/http|www|com|br|\/|\./gi,"").trim());this.shortenedUrl=`po.com/${d.substr(d.length-3)}`+this.baseUrls.length,this.baseUrls.push({url:this.url,short:this.shortenedUrl});}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener"]],viewQuery:function(l,i){if(l&1&&$l(De,7,K),l&2){let p;uo(p=fo())&&(i.boxUrlElement=p.first);}},standalone:false,decls:11,vars:7,consts:[["f","ngForm"],["boxUrl",""],[1,"po-row"],["name","url","p-label","Type your URL to be shortened","p-required","",1,"po-lg-6",3,"ngModelChange","ngModel"],["name","shortenedUrl","p-label","URL shortened","p-readonly","",1,"po-lg-6",3,"ngModelChange","ngModel"],["p-label","Shorten URL","p-kind","primary",1,"po-lg-2",3,"p-click","p-disabled"],["p-icon","an an-copy","p-label","Copy",1,"po-offset-lg-4","po-offset-xl-4","po-lg-2",3,"click","p-disabled"],["p-striped","true",3,"p-columns","p-items","p-hide-table-search"]],template:function(l,i){if(l&1){let p=lx();wl(0,"form",null,0)(2,"div",2)(3,"po-url",3),pw("ngModelChange",function(r){return Qy(p),$x(i.url,r)||(i.url=r),Jy(r)}),ng(),$0(),wl(4,"po-input",4,1),pw("ngModelChange",function(r){return Qy(p),$x(i.shortenedUrl,r)||(i.shortenedUrl=r),Jy(r)}),ng(),$0(),ng(),wl(6,"div",2)(7,"po-button",5),ut("p-click",function(){return i.shortenUrl()}),ng(),wl(8,"po-button",6),ut("click",function(){return i.copyToClipboard()}),ng()()(),Ul(9,"po-divider")(10,"po-table",7);}if(l&2){let p=_x(1);Pp(3),hw("ngModel",i.url),G0(),Pp(),hw("ngModel",i.shortenedUrl),G0(),Pp(3),YE("p-disabled",p.invalid),Pp(),YE("p-disabled",!i.shortenedUrl),Pp(2),YE("p-columns",i.urlColumns)("p-items",i.baseUrls)("p-hide-table-search",false);}},dependencies:[aY,iY,oY,ck,ok,Pe,di,Yo,tr,ty],encapsulation:2,changeDetection:1})}return a})();var ke=a=>({"docs-sample-code-tabs":a}),be=(()=>{class a{hideSampleCodeTabs=true;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus";}static \u0275fac=function(l){return new(l||a)};static \u0275cmp=Un({type:a,selectors:[["sample-po-url-shortener-view"]],standalone:false,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(l,i){l&1&&(Ul(0,"br"),wl(1,"blockquote",0)(2,"label",1),Ux(3,"PO Url - Shortener"),ng(),wl(4,"a",2),ut("click",function(){return i.toggleSampleCodeTabs()}),Ul(5,"span"),Ux(6),ng()(),wl(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),Ux(12,"sample-po-url-shortener/sample-po-url-shortener.component.html"),ng(),wl(13,"pre",7),Ux(14,`<form #f="ngForm">
  <div class="po-row">
...
`),ng()()(),wl(15,"po-tab",8)(16,"div")(17,"label",6),Ux(18,"sample-po-url-shortener/sample-po-url-shortener.component.ts"),ng(),wl(19,"pre",9),Ux(20,`import { Component, ElementRef, ViewChild, inject, ChangeDetectionStrategy } from '@angular/core';
...
Executada ao disparar o output `),wl(1309,"code"),Ux(1310,"change"),ng(),Ux(1311," ou "),wl(1312,"code"),Ux(1313,"change-model"),ng(),Ux(1314,", dependendo do valor da propriedade "),wl(1315,"code"),Ux(1316,"triggerMode"),ng(),Ux(1317,"."),ng()()(),wl(1318,"tr",15)(1319,"td",16)(1320,"div",24)(1321,"span",25),Ux(1322," triggerMode"),Ul(1323,"br"),ng()()(),wl(1324,"td",20)(1325,"code",39),Ux(1326,"'change' "),ng(),wl(1327,"code",40),Ux(1328," 'changeModel'"),ng()(),wl(1329,"td",23)(1330,"em")(1331,"strong"),Ux(1332,"(opcional)"),ng()(),wl(1333,"p"),Ux(1334,"Controla se o m\xE9todo ser\xE1 executado no disparo do output "),wl(1335,"code"),Ux(1336,"change"),ng(),Ux(1337," ou "),wl(1338,"code"),Ux(1339,"change-model"),ng(),Ux(1340,"."),ng()()()()());},dependencies:[fP],encapsulation:2})}return a})();var xe=(()=>{class a{route;router;sub;hidePoWebSample=true;samplesLength=3;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(d,l){this.route=d,this.router=l;}goBack(){this.router.navigate(["documentation"]);}improveDocs(){this.router.navigate(["guides/development-flow"]);}ngOnInit(){this.sub=this.route.queryParams.subscribe(d=>{let l=d.view;this.activeTab=l||"doc",this.hidePoWebSample=this.samplesLength===0;});}changeTab(d){this.router.navigate([],{queryParams:{view:d},queryParamsHandling:"merge"}),this.activeTab=d;}ngOnDestroy(){this.sub.unsubscribe();}static \u0275fac=function(l){return new(l||a)(C(Xn),C(Cn))};static \u0275cmp=Un({type:a,selectors:[["ng-component"]],standalone:false,decls:8,vars:4,consts:[["p-title","Url",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(l,i){l&1&&(wl(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),ut("p-click",function(){return i.changeTab("doc")}),Ul(3,"sample-po-url-doc"),ng(),wl(4,"po-tab",3),ut("p-click",function(){return i.changeTab("web")}),Ul(5,"sample-po-url-basic-view")(6,"sample-po-url-labs-view")(7,"sample-po-url-shortener-view"),ng()()()),l&2&&(YE("p-actions",i.actions),Pp(2),YE("p-active",i.activeTab==="doc"),Pp(2),YE("p-hide",i.hidePoWebSample)("p-active",i.activeTab==="web"));},dependencies:[D3,Vd,Rd,ce,Ee,be,he],encapsulation:2})}return a})();var ze=[{path:"",component:xe}],ge=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=fe({type:a});static \u0275inj=ue$1({imports:[vL.forChild(ze),vL]})}return a})();var bt=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=fe({type:a});static \u0275inj=ue$1({imports:[u5,ge]})}return a})();export{bt as DocPoUrlModule};